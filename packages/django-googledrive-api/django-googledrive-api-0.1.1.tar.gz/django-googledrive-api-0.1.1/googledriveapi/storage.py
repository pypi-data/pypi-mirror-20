...
class GoogleDriveFilePermission(object):
    """
        ...
        :param googledriveapi.GoogleDrivePermissionRole g_role: Role associated to this permission
        :param googledriveapi.GoogleDrivePermissionType g_type: Type associated to this permission
...
class GoogleDriveStorage(Storage):
    ...
    def __init__(self, json_keyfile_path=None,
        ...
        :raise ValueError:
        """
        self._json_keyfile_path = json_keyfile_path or settings.GOOGLE_DRIVE_API_JSON_KEY_FILE
    ...
    def _save(self, name, content):
        ...
        file_data = self._drive_service.files().insert(
            ...
            convert=True if mime_type[0] in settings.GOOGLE_DRIVE_API_AUTO_CONVERT_MIMETYPES else False,
        ).execute()
