...
var G__45806 = o;
(G__45806[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
var old_45810 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_45810))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_45810)].join(''):class$));
} else {
}
...
var G__45813 = jsprops;
(G__45813["defaultValue"] = value);

(G__45813["onChange"] = ((function (G__45813,v,value,on_change){
return (function (p1__45811_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__45811_SHARP_);
});})(G__45813,v,value,on_change))
);
...
var vec__45815 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45815,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45815,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45815,(2),null);
...
var temp__4659__auto__ = (function (){var G__45817 = cljs.core.meta(v);
if((G__45817 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__45817);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__45819_45820 = v;
var G__45819_45821__$1 = (((G__45819_45820 == null))?null:reagent.impl.template.key_from_vec(G__45819_45820));
if((G__45819_45821__$1 == null)){
} else {
(jsprops["key"] = G__45819_45821__$1);
}
...
var G__45825 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input,argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__45825) : reagent.impl.template.as_element.call(null,G__45825));
} else {
var p = (function (){var temp__4659__auto__ = (function (){var G__45826 = cljs.core.meta(argv);
if((G__45826 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__45826);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__45827 = (((jsprops == null))?{}:jsprops);
(G__45827["key"] = key);
...
var n__7056__auto___45828 = a.length;
var i_45829 = (0);
while(true){
if((i_45829 < n__7056__auto___45828)){
(a[i_45829] = reagent.impl.template.as_element((a[i_45829])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7056__auto___45831 = a.length;
var i_45832 = (0);
while(true){
if((i_45832 < n__7056__auto___45831)){
var val_45833 = (a[i_45832]);
if((cljs.core.vector_QMARK_(val_45833)) && ((reagent.impl.template.key_from_vec(val_45833) == null))){
(o["no-key"] = true);
} else {
}

(a[i_45832] = reagent.impl.template.as_element(val_45833));

var G__45834 = (i_45832 + (1));
i_45832 = G__45834;
continue;
} else {
}
...
var G__45836 = (cljs.core.count(argv) - first_child);
switch (G__45836) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__45836){
