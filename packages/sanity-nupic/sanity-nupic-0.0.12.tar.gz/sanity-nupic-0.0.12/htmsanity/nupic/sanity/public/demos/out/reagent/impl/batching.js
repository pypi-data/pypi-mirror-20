...
var c_45715 = (a[i]);
if(cljs.core.truth_((c_45715["cljsIsDirty"]))){
(c_45715["forceUpdate"])();
} else {
}
...
var G__45718 = ((function (this$){
return (function (){
return this$.run_queue();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__45718) : reagent.impl.batching.next_tick.call(null,G__45718));
}
});
...
var G__45720 = c;
var G__45720__$1 = (((G__45720 == null))?null:(G__45720["props"]));
if((G__45720__$1 == null)){
return null;
} else {
return (G__45720__$1["argv"]);
}
});
...
var G__45722_45723 = (c["cljsRatom"]);
if((G__45722_45723 == null)){
} else {
reagent.ratom.dispose_BANG_(G__45722_45723);
}
