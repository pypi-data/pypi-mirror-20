...
class SpinnakerApp:
    ...
    def __init__(self, app=None, email=None, project=None, repo=None, prop_path=None):
        ...
        self.appinfo = {'app': app,
                        ...
                        'repo': repo}
        self.appname = app
        self.settings = get_properties(prop_path) if prop_path else None
    ...
    def create_app(self):
        ...
        self.appinfo['chaosmonkey'] = self.settings['pipeline']['chaosmonkey'] if self.settings else False
