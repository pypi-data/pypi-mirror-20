...
setup(
    ...
    description='enotas API wrapper using tapioca',
    long_description=readme,
    author=get_author(package),
    author_email=get_email(package),
    url='https://bitbucket.com/wpensar/tapioca_enotas',
    packages=[
        'tapioca_enotas',
    ],
    package_dir={'tapioca_enotas': 'tapioca_enotas'},
