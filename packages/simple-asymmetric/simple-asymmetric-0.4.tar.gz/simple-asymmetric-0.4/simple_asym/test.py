...
class TestCrypto(unittest.TestCase):
    ...
    def test_hashes_password(self):
        password = 'hunter2'
        salt = bytes([88, 240, 185, 66, 195, 101, 160, 138, 137, 78, 1, 2, 3, 4, 5, 6])
    ...
    def test_rsa_encrypt_and_decrypt(self):
        ...
        ciphertext = rsa_encrypt(
            key_pair['public_key'], key_pair['private_key'], message)
...
class TestAsym(unittest.TestCase):
    ...
    def test_encrypt_decrypt_using_rsa(self):
        ...
        decrypted = self.asym.rsa_decrypt(
            self.asym.key_pair['public_key'], ciphertext)
    ...
    def test_get_and_set_encrypted_shared_symmetric_key(self):
        ...
        self.asym.set_symmetric_key_from_encrypted(
            self.asym.get_public_key(), encrypted_key)
    ...
    def test_bob_and_alice_integration_test(self):
        ...
        alice.set_symmetric_key_from_encrypted(
            bob.get_public_key(), encrypted_symmetric_key)
