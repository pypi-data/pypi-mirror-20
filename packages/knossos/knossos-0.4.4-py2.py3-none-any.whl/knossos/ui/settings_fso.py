...
class Ui_FsoSettingsForm(object):
    def setupUi(self, FsoSettingsForm):
        ...
        self.openConfigFolder = QtWidgets.QPushButton(FsoSettingsForm)
        self.openConfigFolder.setObjectName("openConfigFolder")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.openConfigFolder)
    ...
    def retranslateUi(self, FsoSettingsForm):
        ...
        self.openConfigFolder.setText(_translate("FsoSettingsForm", "Open FS2\'s config folder"))
