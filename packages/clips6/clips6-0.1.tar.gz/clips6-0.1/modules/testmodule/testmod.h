...
__PYX_EXTERN_C DL_IMPORT(int) the_answer(void *);
...
__PYX_EXTERN_C DL_IMPORT(int) print_params(void *);
__PYX_EXTERN_C DL_IMPORT(PyObject) *make_env(void *);
__PYX_EXTERN_C DL_IMPORT(int) init_clips6_testmod(void *);
