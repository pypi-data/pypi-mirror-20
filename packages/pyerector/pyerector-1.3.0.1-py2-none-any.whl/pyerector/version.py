...
retrieve using this interface."""
    def __init__(self):
        V['pyerector.release.version'] = 'b9bb7e36453c'
        V['pyerector.release.branch'] = 'default'
        V['pyerector.release.tags'] = '1.3.0.1'
        V['pyerector.release.product'] = 'pyerector'
        V['pyerector.release.number'] = '1.3.0.1'
...
HG_VERSION = 'b9bb7e36453c'
HG_BRANCH = 'default'
HG_TAGS = '1.3.0.1'
RELEASE_PRODUCT = 'pyerector'
RELEASE_NUMBER = '1.3.0.1'
