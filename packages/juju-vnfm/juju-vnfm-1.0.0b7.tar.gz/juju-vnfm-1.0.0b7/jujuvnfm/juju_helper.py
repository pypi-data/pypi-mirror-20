    ...
    def __init__(self, vim_name):
        ...
        for attempt in range(0, 5):
            try:
                ...
                if attempt == 4:
                    log.error('After five attempts the SSLError is still occurring. Looks like there is a real problem.')
                    raise ssl_error
                log.warning('SSLError occurred while connecting to the controller {}. Try one more time.'.format(controller_name))
