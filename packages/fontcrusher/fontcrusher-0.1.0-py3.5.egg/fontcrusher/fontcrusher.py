...
def save_the_font(font_object, saved_font_path):
    "Function to save font to file, can save in any format"
    font_object.flavor = saved_font_path.split('.')[-1]
    font_object.save(saved_font_path)
