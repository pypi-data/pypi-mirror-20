...
tek_logger = gateway_helpers.get_logger(log_filename='tek_grl_test.log',
...
class Grl_Test(object):
    def __init__(self):
        ...
        try:
            tek_logger.info("getting instrument")
            self.tek = gateway_helpers.get_instrument(BASE_RUN)
        except Exception:
            self.exception_counter += 1
            tek_logger.info("exception getting instrument", exc_info=True)
        try:
            tek_logger.info("getting instrument")
            ...
            self.exception_counter = 0
            tek_logger.info("exception getting usb controller", exc_info=True)
    ...
    def set(self, obj, attr, val):
        ...
        try:
            ...
            tek_logger.info("TEK SUCCESS set %s with %s" % (attr, val))
        except Exception:
            tek_logger.info("TEK ERROR: %s not set with %s" % (attr, val))
            tek_logger.debug(traceback.format_exc())
            self.exception_counter += 1
    ...
    def write(self, command="", tek=None):
        ...
        try:
            tek._write(command)
            tek_logger.info("TEK SUCCESS write:%s" % command)
        except Exception:
            tek_logger.info("TEK ERROR: exception with write:%s" % command)
            tek_logger.debug(traceback.format_exc())
            self.exception_counter += 1
    ...
    def fourth_tek_commands(self, tek=None):
        ...
        tek_logger.info("length of fetched waveform: %s" % len(waveform))
        # tek._ask('*OPC?') 
    ...
    def run_grl_test(self):
        ...
        for index, code_block in enumerate(code_blocks):
            try:
                code_block()
                tek_logger.info("Ran code_blocks[%s], now sleeping %s sec(s)" 
                                 % (index, sleep_secs))
                time.sleep(sleep_secs)
            except Exception:
                tek_logger.info("exception with code_blocks[%s]" % index)
                tek_logger.info(traceback.format_exc())
                self.exception_counter += 1
    ...
    def post_waveform_file(self, filename):
        ...
        tek_logger.info("POST file response.reason: %s" % response.reason)
        tek_logger.info("POST file response.status_code: %s" % response.status_code)
...
#     tek.trigger.continuous = True
    ...
    # def run_grl_test(self):
        ...
        # except Exception:
        #     self.exception_counter += 1
        #     tek_logger.info("exception with first tek commands")
        #     tek_logger.info(traceback.format_exc())
        ...
        # except Exception:
        #     self.exception_counter += 1
        #     tek_logger.info("exception with first pd commands")
        #     tek_logger.info(traceback.format_exc())
        ...
        # except Exception:
        #     self.exception_counter += 1
        #     tek_logger.info("exception with second tek commands")
        #     tek_logger.info(traceback.format_exc())
        ...
        # # except Exception:
        # #     self.exception_counter += 1
        # #     tek_logger.info("exception with second pd commands"

        # try:
        #     third_tek_commands(self.tek)
        # except Exception:
        #     self.exception_counter += 1
        #     tek_logger.info("exception with third tek commands")
        #     tek_logger.info(traceback.format_exc())
        ...
        # except Exception:
        #     self.exception_counter += 1
        #     tek_logger.info("exception with third pd commands")
        #     tek_logger.info(traceback.format_exc())
        ...
        # except Exception:
        #     self.exception_counter += 1
        #     tek_logger.info("exception with fourth tek commands")
        #     tek_logger.info(traceback.format_exc())
        ...
        # # except Exception:
        # #     self.exception_counter += 1
        # #     tek_logger.info("exception with fourth pd commands"
        # #     tek_logger.info(traceback.format_exc()
