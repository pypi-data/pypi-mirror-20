...
class BatchMixin(object):
    ...
    def absolute_filepath(self, config, name_attr='filename'):
        """
        ...
        """
        return os.path.join(self.filedir(config), getattr(self, name_attr))
    ...
    def delete_data(self, config):
        ...
        """
        # TODO: make this more generic for other filename attrs
