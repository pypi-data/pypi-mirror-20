...
class RestFunctionSerializer(object):
  ...
  def fun_args_parser(action_obj, request):
    ...
    response_dict = {}
    action_pars__keys     = list( action_obj.parameters.keys() )
    opt_action_pars__keys = list( action_obj.opt_parameters.keys() )
    parameter_dict__keys  = list( parameter_dict.keys() )
  ...
  def result_parser(action_obj, results):
    ...
    action_keys         = list( action_obj.return_dict.keys() )
    ...
    if type_obj_result == dict:
      ...
      obj_result_keys = list(results.keys())
