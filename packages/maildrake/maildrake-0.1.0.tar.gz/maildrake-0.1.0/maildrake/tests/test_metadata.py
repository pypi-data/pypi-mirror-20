...
@unittest.mock.patch.object(metadata, 'distribution_name', new="mock-dist")
class get_distribution_version_info_TestCase(
        testscenarios.WithScenarios,
        unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_distribution = unittest.mock.MagicMock()
