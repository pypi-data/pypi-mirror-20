...
class ParetoMultiLongLong(object):
    ...
    def addvalue(self, val, idx):
        """
        addvalue(ParetoMultiLongLong self, mvalueVector val, long const idx) -> bool
...
def ParetoMultiLongLong_showvalue(p):
    """ParetoMultiLongLong_showvalue(mvalueVector p)"""
    return _oalib.ParetoMultiLongLong_showvalue(p)
...
class ParetoMultiDoubleLong(object):
    ...
    def __init__(self):
        """
        __init__(Pareto<(mvalue_t<(long)>,long)> self) -> ParetoMultiDoubleLong
    ...
    def allvalues(self):
        """
        allvalues(ParetoMultiDoubleLong self) -> std::vector< Pareto< mvalue_t< long >,long >::pValue,std::allocator< Pareto< mvalue_t< long >,long >::pValue > >
    ...
    def addvalue(self, val, idx):
        """
        addvalue(ParetoMultiDoubleLong self, mvalueVector val, long const idx) -> bool
...
def ParetoMultiDoubleLong_showvalue(p):
    """ParetoMultiDoubleLong_showvalue(mvalueVector p)"""
    return _oalib.ParetoMultiDoubleLong_showvalue(p)
