...
class AssetManager(AMaaSModel):
    ...
    def __init__(self, asset_manager_type, asset_manager_id=None, client_id=None, asset_manager_status='Active',
                 party_id=None, default_book_owner_id=None, default_timezone='UTC',
                 default_book_close_time=timedelta(hours=18), *args, **kwargs):
