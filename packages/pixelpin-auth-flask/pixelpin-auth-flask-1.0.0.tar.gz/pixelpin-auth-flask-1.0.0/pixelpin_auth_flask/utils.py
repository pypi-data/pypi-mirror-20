...
from pixelpin_auth_core.utils import module_member, setting_name, get_strategy
from pixelpin_auth_core.backends.utils import get_backend


DEFAULTS = {
    'STORAGE': 'pixelpin_auth_flask_sqlalchemy.models.FlaskStorage',
    'STRATEGY': 'pixelpin_auth_flask.strategy.FlaskStrategy'
}
