...
def _wrap_value(value, strict=True):
    wrapped = value
    if isinstance(value, dict):
        wrapped = DictBacked(value, strict)
...
class DictBacked(object):
    ...
    def __iter__(self):
        return (k for k in self._contents.keys())
    ...
    def __getitem__(self, item):
        return _wrap_value(self._contents[item], self._strict)
    ...
    def __getattr__(self, key):
        ...
        return _wrap_value(value, self._strict)
