...
class NautilusCTSResolver(CTSCapitainsLocalResolver):
    ...
    def __init__(self, resource, name=None, logger=None, cache=None, dispatcher=None, store=None):
        ...
        self.inventory_graph_key = _cache_key("Nautilus", self.name, "Inventory", "Graph")
    ...
    def inventory(self, value):
        ...
        self.cache.set(self.inventory_graph_key, MyCapytain.common.constants.GRAPH)
    ...
    def get_or(self, cache_key, callback, *args, **kwargs):
        ...
        if cached is not None:
            if cache_key is self.inventory_cache_key:
                MyCapytain.common.constants.GRAPH = self.cache.get(self.inventory_graph_key)
            return cached
        else:
            try:
