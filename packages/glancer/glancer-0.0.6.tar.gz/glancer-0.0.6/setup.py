...
setup(
    ...
    author='Jeremy Maitin-Shepard, Jan Funke, Ignacio Tartavull',
    author_email='jbms@google.com, jfunke@iri.upc.edu, tartavull@gmail.com',
    url='https://github.com/seunglab/neuroglancer',
