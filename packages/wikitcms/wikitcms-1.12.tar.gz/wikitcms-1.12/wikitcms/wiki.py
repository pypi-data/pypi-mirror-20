...
# available.
class ResTuple(
    namedtuple('ResTuple', 'testtype release milestone compose testcase '
    'section testname env status user bugs comment bot')):
...
class Wiki(mwclient.Site):
    ...
    def allresults(self, prefix=None, start=None, end=None, redirects='all'):
        ...
        """
        gen = li.TcmsPageList(self, prefix=prefix, start=start, end=end,
                              namespace=116, redirects=redirects)
        return gen

    def alltestdays(self, prefix=None, start=None, end=None, redirects='all'):
        ...
        for resitem in reslist:
            ...
            if not key in pagedict:
                ...
                try:
                    ...
                    # None to cache that information, add this result
                    # to the 'insufficients' list, and move on to the
                    # next.
                    pagedict[key] = None
                    insufficients.append(resitem)
                    continue
            elif not pagedict[key]:
