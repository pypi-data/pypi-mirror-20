...
class ComposeEvent(Event):
    ...
    def __init__(self, wiki, release, milestone="", compose="", date="",
                 rawhide=""):
        ...
        if date:
            ...
            self.category_page = page.CategoryPage(wiki, release, nightly=True)
        else:
    ...
    def real_pages(self):
        ...
        """
        return self.site.allpages(prefix="Fedora {} ".format(self.version))
