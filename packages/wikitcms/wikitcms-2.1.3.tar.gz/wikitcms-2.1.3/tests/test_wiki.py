...
def fake_findrow(self, testcase='', section='', testname=''):
...
class TestWiki:
    ...
    @mock.patch('mwclient.page.Page.__init__', return_value=None)
    @mock.patch('mwclient.page.Page.text', return_value=FAKE_CURRENT_COMPOSE)
    @mock.patch('wikitcms.wiki.Wiki.get_validation_event')
    def test_current_event(self, fakeget, faketext, fakeinit):
        ret = self.site.current_event
        fakeget.assert_called_with(compose='1.1', milestone='Alpha', release='24')
    ...
    @mock.patch('mwclient.page.Page.__init__', return_value=None)
    @mock.patch('mwclient.page.Page.text', return_value=FAKE_CURRENT_COMPOSE)
    @mock.patch('wikitcms.event.NightlyEvent')
    @mock.patch('wikitcms.event.ComposeEvent')
    ...
    @mock.patch('wikitcms.event.NightlyEvent.__init__', return_value=None)
    ...
    @mock.patch('mwclient.page.Page.__init__', return_value=None)
    @mock.patch('mwclient.page.Page.text', return_value=FAKE_CURRENT_COMPOSE)
    @mock.patch('wikitcms.page.NightlyPage')
    @mock.patch('wikitcms.page.ComposePage')
    ...
    @mock.patch('wikitcms.page.NightlyPage.__init__', return_value=None)
    ...
    @mock.patch('wikitcms.page.NightlyPage.__init__', return_value=None)
    @mock.patch('wikitcms.page.ComposePage.__init__', return_value=None)
    ...
    @mock.patch('wikitcms.page.NightlyPage.add_results')
    @mock.patch('wikitcms.page.ComposePage.add_results')
