    ...
    def save(self, *args, **kwargs):
        ...
        try:
            ...
            try:
                ...
                # look for the expected math question
                qmatch = re.match(r'(\d+)([+-])(\d+)', question)
                if qmatch:
                    answer = 0
                    # if we got one, solve it, without using eval
                    if qmatch.group(2) == '+':
                        answer = int(qmatch.group(1)) + int(qmatch.group(3))
                    elif qmatch.group(2) == '-':
                        answer = int(qmatch.group(1)) - int(qmatch.group(3))
                    logger.debug(
