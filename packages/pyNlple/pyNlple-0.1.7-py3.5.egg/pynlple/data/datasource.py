...
class TsvDataframeSource(Source):
    ...
    def __init__(self, dataframe_path, separator='\t', column_names=None, fill_na_map=None, encoding='utf8', index_column='id'):
    ...
    def get_dataframe(self):
        if self.column_names:
            ...
            header = 'infer'
            names = None
        dataframe = read_csv(self.path, sep=self.separator, header=header, names=names, quoting=csv.QUOTE_NONE, encoding=self.encoding)
    ...
    def set_dataframe(self, dataframe):
        if self.column_names:
            ...
            names = True
        dataframe.to_csv(self.path, sep=self.separator, header=names, quoting=csv.QUOTE_NONE, encoding=self.encoding)
