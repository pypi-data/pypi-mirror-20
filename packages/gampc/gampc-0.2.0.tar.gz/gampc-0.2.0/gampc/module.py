...
class Module(Gtk.Bin):
    ...
    def __init__(self, shared):
        ...
        self.shared = shared
        self.config = self.shared.config.setdefault(self.name, {})
...
class PanedModule(Module):
    ...
    def __init__(self, shared):
        ...
        self.paned = Gtk.Paned(orientation=Gtk.Orientation.HORIZONTAL, position=self.config.setdefault(self.CONFIG_PANE_SEPARATOR, 100), visible=True)
