 ...
 * 
 */
  __pyx_tuple__3 = PyTuple_Pack(7, __pyx_n_s_msg, __pyx_n_s_msg, __pyx_n_s_length, __pyx_n_s_ud, __pyx_n_s_result, __pyx_n_s_detected_charset, __pyx_n_s_detected_confidence); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__3);
  __Pyx_GIVEREF(__pyx_tuple__3);
  __pyx_codeobj__4 = (PyObject*)__Pyx_PyCode_New(1, 0, 7, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__3, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_yossy_src_cChardet_src_cch, __pyx_n_s_detect_with_confidence, 14, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__4)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
