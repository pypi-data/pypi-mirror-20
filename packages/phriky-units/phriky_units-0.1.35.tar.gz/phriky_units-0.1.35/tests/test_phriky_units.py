...
class TestPhriky_units(unittest.TestCase):
    ...
    # REMOVED BECAUSE Vector3 getX should not be meters
    # getXYZ 
    ...
    # dt Heuristic
    # def test_it_heuristic_dt_vel_1 (self):
        # cps_unit_checker = CPSUnitsChecker()
        # cps_unit_checker.SHOULD_MATCH_ON_HEURISTIC_VARIABLE_NAMES = True 
        # dump_file  = './dump_files_for_tests/test_it_var_name_heuristic_vel_1.cpp.dump'
        # if os.path.exists('./tests'):
            # dump_file = dump_file[1:]  #REMOVE LEADING .
            # dump_file = './tests' + dump_file
        # source_file  = dump_file.replace('.dump','')
