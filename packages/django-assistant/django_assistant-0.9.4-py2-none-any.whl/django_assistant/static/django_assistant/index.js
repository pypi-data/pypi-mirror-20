	...
	success : function(json){
		...
		var url_item_code = '<div class="api_item" url_value="'+api["url"]+'">\
					<div class="row">\
						...
						<span class="api_status api_status_'+api["api_status"]+'">\
						</span>\
						<span style="color:grey;font-size:13px;margin-right:20px;">'+api["http_type"]+' </span><span class="fetch_api_details api_url_value" api_id="'+api["api_id"]+'"> '+api["url"]+'</span>\
					    </div>\
