	...
	success : function(json){
		...
		var url_item_code = '<div class="api_item" url_value="'+api["url"]+'">\
					<div class="row">\
						...
						<span style="color:grey;font-size:12px;margin-right:20px;">'+api["http_type"]+api["api_status"]+' </span><span class="fetch_api_details api_url_value" api_id="'+api["api_id"]+'"> '+api["url"]+'</span>\
					    </div>\
