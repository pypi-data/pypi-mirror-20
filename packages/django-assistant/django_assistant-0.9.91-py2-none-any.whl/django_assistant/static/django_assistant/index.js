$(document).ready(function(){
	...
	$.ajax({
		...
		$.each(params,function(index,item){
		    ...
		    var keyValue_code = ''
		    $('#id_inputs .list-inline').prepend('<li class="existing_input_header existing_input_'+index+'" tab="level2" target="existing_input_'+index+'">Input '+index+'<p class="delete_input pull-right"  input_index="'+index+'" input_id="'+item["inputset_id"]+'">X</p></li>')
			...
			var keyValue_code_temp =	'<div class="key_value_pair_each">\
							...
							<div class="tags_container">Tags : \
							    <div class="tags_values">trial1,trial2</div>\
							</div>\
							'
	...
	success:function(json){
		...
		$('body').append("<li>tag : "+v["id"]+" "+v["name"]+"</li>")
