$(document).ready(function(){
	...
	$.ajax({
		...
		$.each(params,function(index,item){
		    ...
		    var keyValue_code = ''
		    $('#id_inputs .list-inline').prepend('<li class="existing_input_header existing_input_'+index+'" tab="level2" target="existing_input_'+index+'">Input '+index+'<input class="delete_input" input_index="'+index+'" input_id="'+item["inputset_id"]+'" type="button" value="X"></li>')
