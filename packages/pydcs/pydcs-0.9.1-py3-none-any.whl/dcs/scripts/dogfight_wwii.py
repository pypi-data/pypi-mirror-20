...
def main():
    ...
    # georgia = m.country(dcs.countries.Georgia.name)
    # aaa_rect = dcs.Rectangle.from_point(battle_point, 3000)
    # for x in range(0, 5):
    #     m.vehicle_group(georgia, "aaa " + str(x), dcs.countries.Georgia.Vehicle.AirDefence.AAA_ZU_23_Emplacement,
    #                     position=aaa_rect.random_point())
