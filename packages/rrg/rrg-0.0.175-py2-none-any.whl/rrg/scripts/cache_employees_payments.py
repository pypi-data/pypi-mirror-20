...
parser.add_argument(
    '--datadir',
    required=True,
    help='datadir dir with ar.xml', default='/php-apps/cake.rocketsredglare.com/rrg/data/employees/payments/')
...
def cache_employees_payments_ep():
    """
...
def cache_employees_payments():
    ...
    routine(session, os.path.join(app.config['DATADIR'], 'employees', 'payments'), EmployeePayment, crypter)
    session.commit()
