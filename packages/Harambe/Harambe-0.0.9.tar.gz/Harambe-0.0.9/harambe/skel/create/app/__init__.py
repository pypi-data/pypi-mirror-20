...
AVAILABLE_APPS = {
    ...
    "ERROR_PAGE": "harambe.contrib.views.error_page",

    # Maintenance page. When uncommented, the whole site will
    # show a maintenance page
    "MAINTENANCE_PAGE": ("harambe.contrib.views.maintenance_page", {
            "on": False,
    ...
    # give access etc
    # Require to run `harambe syncdb` to setup the db
    # Also, run once `harambecli auth:create-super-admin email@xyz.com` to
