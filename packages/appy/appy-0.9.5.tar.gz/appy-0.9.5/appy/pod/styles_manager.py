...
class TableProperties(Properties):
    ...
    def __init__(self, pageWidth=None, px2cm=px2cmRatio, wideAbove=495,
                 minColumnWidth=0.07, optimalColumnWidths=False):
...
class Css2odf:
    ...
    # they are different.
    valuesMap = {'textalign': {'left': 'start', 'center': 'center',
...
class StylesManager:
    ...
    def getStyleFromMapping(self, xhtmlElem, styles):
    ...
    def findStyle(self, xhtmlElem, localStylesMapping):
        ...
        if not res and localStylesMapping.has_key(elem):
            ...
            res = self.getStyleFromMapping(xhtmlElem, styles)
        # (3)
