...
class Ref(Field):
    ...
    def __init__(self, klass=None, attribute=None, validator=None,
      ...
      mapping=None, label=None, queryable=False, queryFields=None,
      ...
      showActions=True, collapsible=False, links=True, viewAdded=True,
    ...
    def getColSets(self, obj, tool, tiedClassName, dir):
        '''Gets the ColSet instances corresponding to every showable set of
           columns.'''
        res = self.getAttribute(obj, 'shownInfo')
    ...
    def getReferenceLabel(self, obj, refObject, unlimited=False, dir='ltr'):
        ...
        for col in self.getColSets(obj, tool, className, dir)[0].specs:
            name = col.field.name
