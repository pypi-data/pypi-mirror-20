...
class BufferAction:
    ...
    def __init__(self, name, buffer, expr, elem, minus):
        ...
        # NullAction or ElseAction, for example).
        self.expr = expr
...
class ElseAction(IfAction):
    ...
    def __init__(self, name, buff, expr, elem, minus, ifAction):
        IfAction.__init__(self, name, buff, None, elem, minus)
...
class ForAction(BufferAction):
    ...
    def __init__(self, name, buff, expr, elem, minus, iter):
        BufferAction.__init__(self, name, buff, expr, elem, minus)
...
class VariablesAction(BufferAction):
    ...
    def __init__(self, name, buff, elem, minus, variables):
        ...
        BufferAction.__init__(self,name, buff, None, elem, minus)
