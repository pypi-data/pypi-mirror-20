...
class BaseSwitchFrame(BaseLabelFrame):
    ...
    def __init__(self,
        ...
        super(BaseLabelFrame, self).__init__(self, *args, **kwargs)
        ...
        for switch_object, switch_label in self.switches.iteritems():
            ...
            self.switches[switch_object] = self.switch_widget(frame=self,
    ...
    def switch_state(self,
                     switch):
        return self.switches[switch].switch_state
