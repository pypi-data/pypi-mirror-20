...
from kervi.hal.motor_controller import MotorControllerBoard, ServoMotor, ServoControllerBase
...
class _ServoController(ServoControllerBase):
    def __init__(self, pwm_device):
        ServoControllerBase.__init__(self, "PCA9685", 16)
        self.pwm_device = pwm_device

    def set_position(self, channel, position, adjust_min=0, adjust_max=0, adjust_center=0):
        pulse_min = 150 + 150 * adjust_min
        pulse_center = 225 + 225 * adjust_center
        ...
        pulse *= 1000
        pulse //= pulse_length
        self.pwm_device.set_pwm(channel, 0, pulse)

class PCA9685MotorHAT(MotorControllerBoard):
