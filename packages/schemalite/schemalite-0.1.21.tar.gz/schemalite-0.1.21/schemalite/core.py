            ...
            if field_name not in data:
                ...
                if allowed == False:
                            ...
                            if field_type == dict:
                                ...
                                if 'permitted_values_for_list_items' in field_props:
                                    for idx, item in enumerate(data[field_name]):
                                        if item is not None and item not in field_props['permitted_values_for_list_items']:
                    ...
                    if 'permitted_values' in field_props:
                        if data[field_name] is not None and data[field_name] not in field_props['permitted_values']:
