var textmatchAPI = '/place-search/json/',
    geocodingAPI = 'https://maps.googleapis.com/maps/api/geocode/json?address=%QUERY&components=country:' + HURUMAP_COUNTRY_CODE + '&region=' + HURUMAP_COUNTRY_CODE + '&key=' + GOOGLE_GEOCODE_API_KEY,
