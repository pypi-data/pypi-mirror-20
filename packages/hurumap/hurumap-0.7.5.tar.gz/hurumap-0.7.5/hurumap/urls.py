...
from hurumap.views import (HomepageView, GeographyDetailView, GeographyJsonView, PlaceSearchJson,
...
EMBED_CACHE_TIME = settings.HURUMAP.get('embed_cache_secs', STANDARD_CACHE_TIME)
