...
class ICalendar(BaseEndpoint):
	...
	def update (self, uid , event , sendNotifications ):
		...
		data = __VEventSerDer__().encode(event)
	...
	def search (self, query ):
		...
		return self.handleResult__(__ListResultSerDer__(__ItemValueSerDer__(__VEventSerDer__())), response)
	...
	def getComplete (self, uid ):
		...
		from netbluemind.core.container.model.ItemValue import ItemValue
		from netbluemind.core.container.model.ItemValue import __ItemValueSerDer__
		return self.handleResult__(__ItemValueSerDer__(__VEventSerDer__()), response)
