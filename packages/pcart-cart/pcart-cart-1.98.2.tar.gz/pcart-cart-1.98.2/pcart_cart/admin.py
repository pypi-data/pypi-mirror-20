...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('number', 'customer', 'site', 'total_price', 'added', 'changed')
    search_fields = ('customer', 'number')
    date_hierarchy = 'added'
    raw_id_fields = ('customer',)
    readonly_fields = ('number', 'content_preview', 'total_price', 'total_weight')
    ordering = ('-added',)
    fields = [
        'site', 'customer', 'content_preview',
        'shipping_data', 'payment_data',
