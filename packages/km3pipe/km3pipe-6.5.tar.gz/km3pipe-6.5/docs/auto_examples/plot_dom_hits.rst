...
.. rst-class:: sphx-glr-script-out
 ...
 Out::
    ...
    ============================================================
    ============================================================
    501 cycles drained in 6.64s (CPU 6.67s). Memory peak: 317.45 MB
    Statistics are based on the last 500 cycles.
      wall  mean: 0.01s  medi: 0.01s  min: 0.01s  max: 0.24s  std: 0.01s
      CPU   mean: 0.01s  medi: 0.01s  min: 0.01s  max: 0.22s  std: 0.01s
...
**Total running time of the script:** ( 0 minutes  11.331 seconds)
