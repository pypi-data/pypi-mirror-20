...
class CallUnits(unittest.TestCase):
    ...
    def __init__(self,*args,**kargs):
        ...
        self.myTestPath3Rel = self.myTestPath2Rel +os.sep+ self.myTestPath2Rel
        ...
        self.myTestPath2 = self.myBase+os.sep+self.myTestPath2Rel #@UnusedVariable
        self.myTestPath2 = self.myBase+os.sep+self.myTestPath3Rel #@UnusedVariable
    ...
    def testCase000(self):
        ...
        rpath = os.path.normpath('g/h/')
        plist = ''
        plist += os.pathsep+ self.myTestPath0[:-3]
        plist += os.pathsep+ self.myTestPath1[:-3]
        plist += os.pathsep+ self.myTestPath2[:-3]
        plist += os.pathsep+ self.myTestPath3[:-3]
        plist += os.pathsep+ self.myTestPath0[:-3]
        plist += os.pathsep+ self.myTestPath1[:-3]
        plist += os.pathsep+ self.myTestPath2[:-3]
        plist += os.pathsep+ self.myTestPath3[:-3]
