...
class CallUnits(unittest.TestCase):
    ...
    def testCase000(self):
        ...
        filesysobjects.FileSysObjects.clearPath(plistRaw,**{'redundant':True,'shrink':True,}) # here just a demo
        plist = [
            self.myTestPath0,
            self.myTestPath1,
            self.myTestPath3+os.pathsep+self.myTestPath2,
        ]        
        assert plist == plistRaw

        kargs = {'matchlvlupward':0}
        px = []
