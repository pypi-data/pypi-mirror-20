...
class YaffProject(object):
    ...
    def get_sources(self):
        ...
        for template_file in self.template_files:
            target_filename = self.headers['headers']['namespace'] + '_' + self.headers['headers']['API_version'] \
                              + '.html'
    ...
    def write_target_file(self, target_type):
        ...
        if target_type == 'css':
            target_filename = self.headers['headers']['namespace'] + '_' + self.headers['headers'][
                'API_version'] + '.' + self.headers['headers']['css_extension']
        else:
            target_filename = self.headers['headers']['namespace'] + '_' + self.headers['headers']['API_version'] + '.' + target_type
