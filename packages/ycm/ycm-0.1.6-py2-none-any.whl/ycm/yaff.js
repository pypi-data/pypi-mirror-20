...
Yaff.Page = Yaff.extend({
    ...
    register_components: function() {
        ...
        var l = self.selector_class_map.length;
        for (var i=0; i<l; i++) {
            self.$el.find(self.selector_class_map[i].selector).each(function(){
                var cls = self.selector_class_map[i].class;
                var view_obj = new Yaff[cls](this);
