...
def sct_from_log_response(ct_log_response):
    data_dict = {
        ...
        'extensions': None,
        'signature_alg_hash': int(0),
        'signature_alg_sign': int(0),
        'signature_len': None,
        ...
        'timestamp': ct_log_response.timestamp,
...
def create_and_validate_sct_of_cert(ee_cert, ct_log_response, log_key_str):
