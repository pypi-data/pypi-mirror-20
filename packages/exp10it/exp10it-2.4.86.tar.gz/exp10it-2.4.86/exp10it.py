...
def figlet2file(logo_str, file_abs_path, print_or_not):
    ...
    try:
        ...
        print("If you are using macOS,please run brew install figlet as a none root user")
...
def blog():
    ...
    file_abs_path = "~/myblog/_posts/" + filename
...
def get_sqlmap_result_and_save_result(url):
    ...
    if url[:4] == 'http':
        ...
        domain = url
    target_folder = "~/.sqlmap/output/" + domain
    try:
