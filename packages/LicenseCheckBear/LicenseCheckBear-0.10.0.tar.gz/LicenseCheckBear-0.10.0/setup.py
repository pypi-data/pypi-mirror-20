...
if __name__ == '__main__':
    try:
        setup(name='LicenseCheckBear',
              version='0.10.0',
              description=''''LicenseCheckBear' bear for coala (http://coala.rtfd.org/)''',
    ...
    ''',
              entry_points={'coalabears': ['LicenseCheckBear = coalaLicenseCheckBear']},
              classifiers=[
