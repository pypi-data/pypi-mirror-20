...
def upload_pic_return_dict(request,f=None,name=None,resize=(),limit_size=20,limit_file_type=('jpg','jpeg','bmp','png','gif','tif')):
    ...
    try:
        ...
        if f:
            ...
            if resize:
                resize_image_success = imagelib.create_small_pic_from_file(file=real_file,dst_w=resize[0],dst_h=resize[1],quality=quality,dst_img=real_file,is_thumbnails=True)
