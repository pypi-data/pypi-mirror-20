...
accoppiamenti di un nuovo turno generati automaticamente: generalmente questo è necessario solo
...
pannello in basso :guilabel:`Abbinamenti turno corrente` e ricombinare arbitrariamente gli
incontri scambiando tra loro i vari concorrenti con il drag&drop.
