...
from hd_es_tools.mongo_connector_doc_managers.formatters_proxy import DocumentFormatterProxy
...
class DocManager(DocManagerBase):
    ...
    def upsert(self, doc, namespace, timestamp, update_spec=None):
        ...
        action = {
            ...
            '_type': doc_type,
            '_id': doc_id,
            '_source': self._formatter.format_document(doc_id, doc,  index + "." + doc_type)
        }
    ...
    def insert_file(self, f, namespace, timestamp):
        ...
        doc = self._formatter.format_document(doc_id,doc, index + "." + doc_type)
    ...
    def send_buffered_operations(self):
        ...
        with self.lock:
            try:
                ...
                if action_buffer:
                    LOG.info("action_buffer %s" %json.dumps(action_buffer))
...
class BulkBuffer(object):
    ...
    def update_sources(self):
        ...
        for doc, update_spec, action_buffer_index, get_from_ES in self.doc_to_update:
            ...
            self.action_buffer[action_buffer_index]['_source'] \
                = self.docman._formatter.format_document(doc['_id'],updated,  doc['_index'] + "." + doc['_type'])
