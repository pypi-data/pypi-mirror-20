...
setup(name='hd-es-tools',
      ...
      package_data={
          'hd_es_tools.mongo_connector_doc_managers': ['config_msg.json','config_fav.json', 'config_favdir.json', 'config.json']
      },
      ...
      entry_points={
          'console_scripts': [
              'hd-es-fav-import = hd_es_tools.tools:fav_import_main',
              'hd-es-favdir-import = hd_es_tools.tools:favdir_import_main',
          ],
      },
