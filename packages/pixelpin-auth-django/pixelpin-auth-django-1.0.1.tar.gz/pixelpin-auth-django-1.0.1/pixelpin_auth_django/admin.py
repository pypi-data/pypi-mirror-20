...
from .models import UserPixelpinAuth, Nonce, Association


class UserPixelpinAuthOption(admin.ModelAdmin):
    """Pixelpin Auth user options"""
    ...
    def get_search_fields(self, request=None):
        ...
        if search_fields is None:
            _User = UserPixelpinAuth.user_model()
...
admin.site.register(UserPixelpinAuth, UserPixelpinAuthOption)
