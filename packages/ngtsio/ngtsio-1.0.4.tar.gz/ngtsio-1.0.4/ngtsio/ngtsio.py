...
def get(fieldname, keys, obj_id=None, obj_row=None, time_index=None, time_date=None, time_hjd=None, time_actionid=None, bls_rank=1, indexing='fits', fitsreader='fitsio', simplify=True, fnames=None, root=None, roots=None, silent=False, ngts_version='TEST16A', set_nan=False):
    ...
    if check_files(fnames):
        ...
        #::: always append FLUX and FLAGS for set_nan function
        if set_nan==True:
            keys.append('FLUX')
            keys.append('FLAGS')
...
def standard_fnames(fieldname, ngts_version, root, roots):
    ...
    #            root = '/home/philipp/TEST13/'
                ...
                sys.exit('Invalid value for "ngts_version". Valid entries are: ' + ', '.join(valid_fields))
            root_dil = '/home/sw/work/NGTS/ngts-git/pipeline/tools/prf-measure'
