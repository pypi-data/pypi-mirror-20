...
class DataObject(GraphObject, DataUser, metaclass=MappedClass):
    ...
    def identifier_augment(self):
        ...
        One must also override :meth:`defined_augment` to return True whenever this
        method could return a valid identifier. :exc:`IdentifierMissingException <yarom.graphObject.IdentifierMissingException>` should be
