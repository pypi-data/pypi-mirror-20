...
class _Guay(ComplexPlugin):
    ...
    def get_next_version(self):
        ...
        if self.artifact_info["mode"] == "master":
            ...
            self.share_memory["extra_versions"] = self.artifact_info["build_info"].get("extra_versions_release", [])

        else:
            self.share_memory["latest_version"] = self.artifact_info["mode"]
            self.share_memory["extra_versions"] = self.artifact_info["build_info"].get("extra_versions_dev", [])
