...
class install(_install):
    def run(self):
        ...
        try:
            ...
            logger.error('The % service may not have installed correctly.', PackageInfo.pip_package_name)
            logger.error('Remediation maybe required!, Check the install log for more information.')
            pass
