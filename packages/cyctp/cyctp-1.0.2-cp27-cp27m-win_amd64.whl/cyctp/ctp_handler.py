...
class TdHandler(InstrumentHandler, QuoteHandler, SettlementHandler, TradeHandler, BankHandler):
    ...
    def route(self, t, data, rid, last):
        if t == TD_CALLBACK_TYPE.TD_FRONT_CONNECTED:
            ...
            print_struct(data)
        elif t == TD_CALLBACK_TYPE.TD_RSP_REMOVE_PACK_ORDER and data:
            pass
        elif t == TD_CALLBACK_TYPE.TD_RSP_REMOVE_PACK_ORDER_ACTION and data:
            pass
            ...
            pass
        elif t == TD_CALLBACK_TYPE.TD_RSP_QRY_EXCHANGE_RATE and data:
            pass
        elif t == TD_CALLBACK_TYPE.TD_RSP_QRY_SEC_AGENT_ACID_MAP and data:
            pass
        elif t == TD_CALLBACK_TYPE.TD_RSP_QRY_PRODUCT_EXCH_RATE and data:
            pass
        elif t == TD_CALLBACK_TYPE.TD_RSP_QRY_PRODUCT_GROUP and data:
            pass
            ...
            if data:
                ...
                print_struct(data)
        elif t == TD_CALLBACK_TYPE.TD_RSP_QRY_TRADING_NOTICE and data:
            pass
