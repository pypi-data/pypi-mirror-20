...
setup(
    ...
    description='''Allows to build and/or run your application using simple config file
in yaml format
''',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/Kostanos/run',

    # Author details
    author='Kostya Kostyushko',
    author_email='kostanos@gmail.com',
