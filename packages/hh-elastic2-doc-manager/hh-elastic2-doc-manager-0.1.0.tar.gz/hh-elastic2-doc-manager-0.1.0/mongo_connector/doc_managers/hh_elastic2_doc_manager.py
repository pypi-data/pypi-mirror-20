...
from mongo_connector.doc_managers.formatters_proxy import DocumentFormatterProxy
...
class DocManager(DocManagerBase):
    ...
    def __init__(self, url, auto_commit_interval=DEFAULT_COMMIT_INTERVAL,
                 ...
                 **kwargs):
	print (url, auto_commit_interval,
                 unique_key, chunk_size,
                 meta_index_name, meta_type,
                 attachment_field,
                 kwargs)
        client_options = kwargs.get('clientOptions', {})
        format_options = kwargs.get('formatOptions', {})
        if 'aws' in kwargs:
            if not _HAS_AWS:
                raise errors.InvalidConfiguration(
...
#        self._formatter = DefaultDocumentFormatter()
        self._formatter = DocumentFormatterProxy(format_options) 
    ...
    def update(self, document_id, update_spec, namespace, timestamp):
        ...
        with self.lock:
            ...
            document = self.BulkBuffer.get_from_sources(index,
                                                        doc_type,
                                                        u(document_id))
        #print ("update",document_id, update_spec, namespace, timestamp,document)
	if document:
	...
	#print ("upsert",doc, namespace, timestamp, update_spec)
        ...
        action = {
            ...
            '_type': doc_type,
            '_id': doc_id,
            '_source': self._formatter.format_document(doc,index + "." + doc_type)
        }
	...
	#print ("bulk_upsert",docs, namespace, timestamp)
        def docs_to_upsert():
            doc = None
            for doc in docs:
    ...
    def insert_file(self, f, namespace, timestamp):
        ...
        doc = self._formatter.format_document(doc,index + "." + doc_type)
	...
	#print ("remove",document_id, namespace, timestamp)
...
#	print ("add_doc_to_update",doc, update_spec, action_buffer_index, get_from_ES)
    ...
    def update_sources(self):
        ...
        for doc, update_spec, action_buffer_index, get_from_ES in self.doc_to_update:
            ...
            self.action_buffer[action_buffer_index]['_source'] = self.docman._formatter.format_document(updated, doc['_index']+ "." + doc['_type'])
