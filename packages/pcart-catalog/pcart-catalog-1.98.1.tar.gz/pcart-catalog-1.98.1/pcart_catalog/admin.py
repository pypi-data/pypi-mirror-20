...
class CollectionAdmin(MPTTModelAdmin):
    ...
    list_display = ('title', 'id', 'changed', 'published', 'site', 'slug')
    list_filter = ('published', 'site')
    preserve_filters = True
    search_fields = ['title', 'id']
    fieldsets = (
        (None, {
            'fields': ('site', 'title', 'slug', 'parent', 'description'),
        }),
        (_('SEO'), {
...
class ProductVariantInline(admin.TabularInline):
    ...
    def get_fields(self, request, obj=None):
        ...
        fields = ('title', 'slug', 'tags', 'sku', 'barcode', 'status', 'price') + exclude_prop_fields
        return fields
