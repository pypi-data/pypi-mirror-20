...
class CollectionPluginModel(CMSPlugin):
    ...
    filter_string = models.CharField(_('Filter string'), default='', blank=True, max_length=255)
    sorting = models.CharField(_('Sorting'), default='cheap', blank=True, max_length=100)
    template_name = models.CharField(_('Template name'), default='plugin', max_length=100)
