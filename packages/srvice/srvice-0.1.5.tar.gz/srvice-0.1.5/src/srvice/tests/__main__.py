...
from srvice import __version__
...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('srvice')
...
def main(args=None):
    """
    Called with ``python -m srvice.tests``: run main test suite.
    """
    ...
    import srvice.tests as test_module
