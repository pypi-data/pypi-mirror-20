...
from pyml.components import Attrs, Children
from pyml.components.mixins import HasParentMixin
from pyml.helpers import tag
from pyml.helpers.render import Renderable
from pyml.require.requirable import RequirableMeta, Requirable
from pyml.utils import dash_case
...
class BaseComponent(HasParentMixin, Requirable, Renderable, metaclass=ComponentMeta):
    """
    ...
    def render(self, id=None, cls=None, **kwargs):
        """
