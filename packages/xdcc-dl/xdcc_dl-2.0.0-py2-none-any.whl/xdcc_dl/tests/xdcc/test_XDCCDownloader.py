...
class UnitTests(unittest.TestCase):
    ...
    def test_invalid_whois_query(self):
        ...
        pack = XDCCPack(IrcServer(u"irc.rizon.net"), u"HelloKitty", 1)
        results = XDCCDownloader(u"irc.rizon.net", u"random").download([pack])
        self.assertEqual(results[pack], u"CHANNELJOINFAIL")
