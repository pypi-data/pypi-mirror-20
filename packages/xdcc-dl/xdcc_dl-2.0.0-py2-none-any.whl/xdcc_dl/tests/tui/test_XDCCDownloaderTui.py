...
class UnitTests(unittest.TestCase):
    ...
    def test_adding_pack(self):
        ...
        self.tui.message_edit.set_edit_text(u"/msg xdcc_servbot xdcc send #1")
        self.tui.server_edit.set_edit_text(u"irc.namibsun.net")
    ...
    def test_searching(self):
        ...
        self.select_search_engine(u"namibsun")
    ...
    def test_searching_while_searching(self):
        self.assertEqual(len(self.tui.search_results), 0)
        self.tui.search_term_edit.set_edit_text(u"one punch man")
        self.select_search_engine(u"nibl")
        self.tui.search(None)
        ...
        for pack in self.tui.search_results:
            self.assertNotEqual(u"1_test.txt", pack.get_filename())
    ...
    def test_removing_packs_from_queue(self):
        self.tui.download_queue = xdcc_packs_from_xdcc_message(u"/msg xdcc_servbot xdcc send #1-3")
    ...
    def test_download_while_downloading(self):
        ...
        self.assertNotEqual(self.tui.download_button.get_label(), u"Download")

        self.tui.download_queue = xdcc_packs_from_xdcc_message(u"/msg Ginpachi-Sensei xdcc send #1")
        self.tui.refresh_ui()
        self.tui.download(None)
        ...
        self.assertTrue(os.path.isfile(u"2_test.txt"))
        self.assertTrue(os.path.isfile(u"3_test.txt"))
        self.assertFalse(os.path.isfile(u"Gin.txt"))

    def test_download_wrong_directory(self):
        self.tui.download_queue = xdcc_packs_from_xdcc_message(u"/msg xdcc_servbot xdcc send #1-3",
                                                               server=u"irc.namibsun.net")

        self.assertEqual(self.tui.destination_edit.get_edit_text(), os.getcwdu())
        self.tui.destination_edit.set_edit_text(u"NotADirectory")
        self.assertEqual(self.tui.destination_edit.get_edit_text(), u"NotADirectory")
        ...
        self.assertFalse(os.path.isfile(u"3_test.txt"))
