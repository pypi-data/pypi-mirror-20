...
def findLMNNparams(xtr, ytr, xva, yva):
    ...
    :return:    Klmnn, optimal number of target neighbors during training,
                ...
                dim_out, optimal dimensionality for the transformed inputs,
    ...
    def optimizeLMNN(hp):
        ...
        lmnn_clf = LargeMarginNearestNeighbor(k=K, max_iter=maxiter, verbose=True, dim_out=outdim)
    ...
    domain = [{'name': 'Klmnn', 'type': 'continuous', 'domain': (opt.minK, opt.maxK)},
              ...
              {'name': 'dim_out', 'type': 'continuous', 'domain': (opt.minDim, opt.maxDim)},
