...
class KaptlInit:
    ...
    def initialize_project(self):
        ...
        if self.session_name is not None:
            self.file_info = self.kaptl_client.get_file_info(self.session_name, self.rules, self.stack, self.recipe, mode="full", recipe_version=self.recipe_version,  angular_only=self.angular_only, app_name=self.app_name)
