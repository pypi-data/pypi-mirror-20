...
class KaptlClient:
    ...
    def __init__(self, session, args):
        ...
        self.kaptl_url = Utils.get_kaptl_url(args)
    ...
    def get_file_info(self, session_name, rules, stack, recipe, mode, recipe_version, angular_only=False, app_id=0, app_name=None, email=None):
