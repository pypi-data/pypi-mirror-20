...
def get_var_path(path):
    """
    get the path stored in the 'app/var' directory
    :param path: string
    :return: string
    """
...
AVAILABLE_APPS = {
    ...
    "ERROR_PAGE": "shaft.contrib.views.error_page",

    # Maintenance page. When uncommented, the whole site will
    # show a maintenance page
    "MAINTENANCE_PAGE": ("shaft.contrib.views.maintenance_page", {
            "on": False,
    ...
    "CONTACT_PAGE": (
        "shaft.contrib.views.contact_page",
        {
            "route": "/contact/",
            "nav": {
                "title": "Contact",
    ...
    # Also, run once `shaftcli auth:create-super-admin email@xyz.com` to
    # create the super admin
    "AUTH": [
        ("shaft.contrib.views.auth", {
