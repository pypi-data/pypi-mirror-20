...
import datetime
import uuid
from shaft import (Shaft, models, nav_menu, page_meta, init_app,
...
from shaft.contrib.auth import (current_user, authenticated, is_authenticated,
