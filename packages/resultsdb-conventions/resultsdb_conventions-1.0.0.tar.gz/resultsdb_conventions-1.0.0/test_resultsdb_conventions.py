...
"""Tests for resultsdb_conventions."""
...
import resultsdb_conventions as rdc
...
class TestHelpers:
    ...
    def test_uuid_namespace_default(self):
        ...
        res = rdc.uuid_namespace(str('test'))
        # this is a unicode in py2, native 'str' in py3
        res2 = rdc.uuid_namespace('test')
    ...
    def test_uuid_unicode(self):
        ...
        Unicode characters.
        """
        res = rdc.uuid_namespace('\u4500foobar')
        assert type(res) is uuid.UUID
    ...
    def test_uuid_namespace(self):
        ...
        namespace.
        """
        ns = rdc.uuid_namespace('test')
        res = rdc.uuid_namespace('test', ns)
        assert type(res) is uuid.UUID
        assert str(res) == '18ce9adf-9d2e-57a3-9374-076282f3d95b'

class TestRelease:
    """Tests for the Release class."""
    # FIXME: write tests
    pass
