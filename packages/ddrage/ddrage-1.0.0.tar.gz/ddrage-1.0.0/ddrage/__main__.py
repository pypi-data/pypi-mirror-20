...
def validate_sequence_parameters(args, individuals):
    ...
    # get barcode lengths and insert lengths
...
def get_argument_parser():
    ...
    names_group.add_argument(
        "-o", "--output",
        help="Prefix of the output path. At this point a directory tree will be created that contains all output files created by RAGE.",
        action="store",
    ...
    cov_group.add_argument(
        ...
        help="Maximum coverage for Highly Repetitive Loci (HRLs). The minimum coverage is determined as mean + 2 standard deviations (μ + 2σ) of the main coverage generating function. Default: 2000",
        action="store",
        dest="hrl_max_cov",
        default=2000,
        )
