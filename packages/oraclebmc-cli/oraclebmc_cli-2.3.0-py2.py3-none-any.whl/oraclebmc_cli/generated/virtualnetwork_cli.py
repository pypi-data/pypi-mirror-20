...
You can also add a DNS label for the subnet, which is required if you want the VCN Resolver to resolve hostnames for instances in the subnet. For more information, see [DNS in Your Virtual Cloud Network].""")
...
You can also add a DNS label for the VCN, which is required if you want the instances to use the VCN Resolver option for DNS in the VCN. For more information, see [DNS in Your Virtual Cloud Network].
