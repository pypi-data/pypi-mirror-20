...
@click.pass_context
@cli_util.wrap_exceptions
def launch_instance(ctx, availability_domain, compartment_id, image_id, shape, subnet_id, display_name, hostname_label, ipxe_script_file, metadata):
    kwargs = {}
