...
class Score:
    ...
    def login(self):
        ...
        form_data = {
            ...
            "__EVENTARGUMENT": "",
            "__VIEWSTATE": (
                "/wEPDwUKMTY0Njg4MjEwM2Rke+8H429jkivp4s9ebWp2T6ab"
                "PHNVIEZwg7vX5OhSlZM="
            ),
            "__VIEWSTATEGENERATOR": "C2EE9ABB",
            "__EVENTVALIDATION": (
                "/wEdAAl4J7OeRRdwzXTJtJzl132XDFTzKcXJqLg+OeJ6QAEa2"
                "nY2+Mc6SrnAqio3oCKbxYah3xa5rLP/Bn9R8gnPYyv9Y/jNR+"
                "V3Y2V63r/uGJ6o3e8y1uAcWHw+joLTxl+mj+XJMG57d9TuD5o"
                "RZdFmOwSdT3XUHy040LsOHhWYhzfBA6KeKEbp39eHc9mbdvkC"
                "gxCAbmA7cGEkVJ668VrJNnO6pW65goe9J0qyanJWDyilxw=="
            ),
