...
static_path = rdir_path + r"\static" if sys.platform.startswith("win") else rdir_path + "/static"
files_path = rdir_path + r".\static\files" if sys.platform.startswith("win") else rdir_path +  "/static/files"
# set log level
