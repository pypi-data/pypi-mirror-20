...
PatternExpr_264 = da.pat.TuplePattern([da.pat.ConstantPattern('done')])
PatternExpr_269 = da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.TuplePattern([da.pat.FreePattern(None), da.pat.FreePattern(None), da.pat.FreePattern(None)]), da.pat.TuplePattern([da.pat.ConstantPattern('done')])])
_config_object = {}
...
class Ping(da.DistProcess):
    ...
    def setup(self, pong, **rest_281):
        super().setup(pong=pong, **rest_281)
...
class Pong(da.DistProcess):
    ...
    def setup(self, **rest_281):
        super().setup(**rest_281)
        pass
...
class Node_(da.NodeProcess):
    ...
    def __init__(self, procimpl, props):
        ...
        self._events.extend([da.pat.EventPattern(da.pat.ReceivedEvent, '_Node_ReceivedEvent_0', PatternExpr_264, sources=None, destinations=None, timestamps=None, record_history=True, handlers=[])])
    ...
    def run(self):
        ...
        self._start(pong)
        self._start(ping)
        super()._label('_st_label_261', block=False)
        _st_label_261 = 0
        while (_st_label_261 == 0):
            _st_label_261 += 1
            if PatternExpr_269.match_iter(self._Node_ReceivedEvent_0):
                _st_label_261 += 1
            else:
                super()._label('_st_label_261', block=True)
                _st_label_261 -= 1
        self.output('got done')
