       ...
       i_known_el2: if (eli > 0) then
          ...
          ij_loop: do ij = istart, ifinsh
             ...
             ar_within_cutoff: if (maskfac > 0 .and. &
...
#ifdef INTROSPECTION
                if (allocated(this%attractive_potential)) then
                   this%attractive_potential(this%nbb(ij)) = VAij
                endif
                if (allocated(this%repulsive_potential)) then
                   this%repulsive_potential(this%nbb(ij)) = VRij
                endif
#endif
                ...
                if (allocated(this%VA)) then
                   this%bond_order(this%nbb(ij)) = bij
                endif
