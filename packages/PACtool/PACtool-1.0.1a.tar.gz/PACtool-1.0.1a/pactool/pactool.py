...
if args.freqs:
    ...
    with open('outputfreqs.txt', 'w') as output:
...
if args.hwe:    
    ...
    with open('outputhwe.txt', 'w') as output:
...
if args.ld:
    ...
    with open('outputld.txt', 'w') as output:
...
if args.assoc:
    ...
    with open('outputassoc.txt', 'w') as output:
    ...
    print(" OK!")
    if args.manhattan:
        multitools.manhattan('outputassoc.txt')
    if args.qqplot:
        multitools.qqplot('outputassoc.txt')
