...
class ReactionaryBehaviorTransition(object):
  ...
  __slots__ = (
    '_reactionaryBehaviorTrigger', # Anki.Cozmo.ReactionTrigger
    '_behaviorStarted',            # bool
  )

  @property
  def reactionaryBehaviorTrigger(self):
    "Anki.Cozmo.ReactionTrigger reactionaryBehaviorTrigger struct property."
    return self._reactionaryBehaviorTrigger

  @reactionaryBehaviorTrigger.setter
  def reactionaryBehaviorTrigger(self, value):
    self._reactionaryBehaviorTrigger = msgbuffers.validate_integer(
      'ReactionaryBehaviorTransition.reactionaryBehaviorTrigger', value, 0, 255)
  ...
  def __init__(self, reactionaryBehaviorTrigger=Anki.Cozmo.ReactionTrigger.NoneTrigger, behaviorStarted=False):
    self.reactionaryBehaviorTrigger = reactionaryBehaviorTrigger
  ...
  def unpack_from(cls, reader):
    ...
    _reactionaryBehaviorTrigger = reader.read('B')
    _behaviorStarted = bool(reader.read('b'))
    return cls(_reactionaryBehaviorTrigger, _behaviorStarted)
  ...
  def pack_to(self, writer):
    ...
    writer.write(self._reactionaryBehaviorTrigger, 'B')
    writer.write(int(self._behaviorStarted), 'b')

  def __eq__(self, other):
    if type(self) is type(other):
      return (self._reactionaryBehaviorTrigger == other._reactionaryBehaviorTrigger and
  ...
  def __len__(self):
    return (msgbuffers.size(self._reactionaryBehaviorTrigger, 'B') +
      msgbuffers.size(self._behaviorStarted, 'b'))

  def __str__(self):
    return '{type}(reactionaryBehaviorTrigger={reactionaryBehaviorTrigger}, behaviorStarted={behaviorStarted})'.format(
      type=type(self).__name__,
      reactionaryBehaviorTrigger=self._reactionaryBehaviorTrigger,
      behaviorStarted=self._behaviorStarted)

  def __repr__(self):
    return '{type}(reactionaryBehaviorTrigger={reactionaryBehaviorTrigger}, behaviorStarted={behaviorStarted})'.format(
      type=type(self).__name__,
      reactionaryBehaviorTrigger=repr(self._reactionaryBehaviorTrigger),
...
class MemoryMapMessageBegin(object):
  ...
  def __init__(self, originId=0, rootDepth=0, rootSize_mm=0.0):
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_originId, _rootDepth, _rootSize_mm)
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._originId == other._originId and
        ...
        self._rootSize_mm == other._rootSize_mm)
    else:
      return NotImplemented
  ...
  def __str__(self):
    return '{type}(originId={originId}, rootDepth={rootDepth}, rootSize_mm={rootSize_mm})'.format(
      type=type(self).__name__,
...
class MessageEngineToGame(object):
  ...
  class Tag(object):
    ...
    ObjectTappedFiltered           = 0xc  # Anki.Cozmo.ObjectTappedFiltered
    ObjectTapped                   = 0xd  # Anki.Cozmo.ObjectTapped
    ObjectPowerLevel               = 0xe  # Anki.Cozmo.ObjectPowerLevel
    ObjectAccel                    = 0xf  # Anki.Cozmo.ObjectAccel
    FactoryTestResultEntry         = 0x10 # Anki.Cozmo.FactoryTestResultEntry
    ImageChunk                     = 0x11 # Anki.Cozmo.ImageChunk
    ImageImuData                   = 0x12 # Anki.Cozmo.ImageImuData
    CameraCalibration              = 0x13 # Anki.Cozmo.CameraCalibration
    IMURequest                     = 0x14 # Anki.Cozmo.IMURequest
    LoadedKnownFace                = 0x15 # Anki.Vision.LoadedKnownFace
    RobotRenamedEnrolledFace       = 0x16 # Anki.Vision.RobotRenamedEnrolledFace
    MotorCalibration               = 0x17 # Anki.Cozmo.MotorCalibration
    MotorAutoEnabled               = 0x18 # Anki.Cozmo.MotorAutoEnabled
    CliffEvent                     = 0x19 # Anki.Cozmo.CliffEvent
    PotentialCliff                 = 0x1a # Anki.Cozmo.PotentialCliff
    ProxObstacle                   = 0x1b # Anki.Cozmo.ProxObstacle
    CarryStateUpdate               = 0x1c # Anki.Cozmo.CarryStateUpdate
    SetBodyRadioMode               = 0x1d # Anki.Cozmo.SetBodyRadioMode
    AnimationState                 = 0x1e # Anki.Cozmo.RobotInterface.AnimationState
    UiDeviceAvailable              = 0x1f # Anki.Cozmo.ExternalInterface.UiDeviceAvailable
    RobotConnectionResponse        = 0x20 # Anki.Cozmo.ExternalInterface.RobotConnectionResponse
    RobotDisconnected              = 0x21 # Anki.Cozmo.ExternalInterface.RobotDisconnected
    EngineRobotCLADVersionMismatch = 0x22 # Anki.Cozmo.ExternalInterface.EngineRobotCLADVersionMismatch
    ObjectAvailable                = 0x23 # Anki.Cozmo.ExternalInterface.ObjectAvailable
    ObjectUnavailable              = 0x24 # Anki.Cozmo.ExternalInterface.ObjectUnavailable
    FeatureToggles                 = 0x25 # Anki.Cozmo.ExternalInterface.FeatureToggles
    GoingToSleep                   = 0x26 # Anki.Cozmo.ExternalInterface.GoingToSleep
    EngineLoadingDataStatus        = 0x27 # Anki.Cozmo.ExternalInterface.EngineLoadingDataStatus
    CurrentCameraParams            = 0x28 # Anki.Cozmo.ExternalInterface.CurrentCameraParams
    PerRobotSettings               = 0x29 # Anki.Cozmo.ExternalInterface.PerRobotSettings
    RobotState                     = 0x2a # Anki.Cozmo.ExternalInterface.RobotState
    RobotDelocalized               = 0x2b # Anki.Cozmo.ExternalInterface.RobotDelocalized
    RobotPoked                     = 0x2c # Anki.Cozmo.ExternalInterface.RobotPoked
    RobotStopped                   = 0x2d # Anki.Cozmo.ExternalInterface.RobotStopped
    RobotOffTreadsStateChanged     = 0x2e # Anki.Cozmo.ExternalInterface.RobotOffTreadsStateChanged
    RobotCliffEventFinished        = 0x2f # Anki.Cozmo.ExternalInterface.RobotCliffEventFinished
    RobotOnChargerPlatformEvent    = 0x30 # Anki.Cozmo.ExternalInterface.RobotOnChargerPlatformEvent
    ChargerEvent                   = 0x31 # Anki.Cozmo.ExternalInterface.ChargerEvent
    UnexpectedMovement             = 0x32 # Anki.Cozmo.ExternalInterface.UnexpectedMovement
    RestoreRobotStatus             = 0x33 # Anki.Cozmo.ExternalInterface.RestoreRobotStatus
    RestoreRobotOptions            = 0x34 # Anki.Cozmo.ExternalInterface.RestoreRobotOptions
    DebugString                    = 0x35 # Anki.Cozmo.ExternalInterface.DebugString
    DebugAnimationString           = 0x36 # Anki.Cozmo.ExternalInterface.DebugAnimationString
    RobotProcessedImage            = 0x37 # Anki.Cozmo.ExternalInterface.RobotProcessedImage
    RobotObservedObject            = 0x38 # Anki.Cozmo.ExternalInterface.RobotObservedObject
    RobotObservedPossibleObject    = 0x39 # Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject
    ObjectProjectsIntoFOV          = 0x3a # Anki.Cozmo.ExternalInterface.ObjectProjectsIntoFOV
    RobotObservedFace              = 0x3b # Anki.Cozmo.ExternalInterface.RobotObservedFace
    RobotChangedObservedFaceID     = 0x3c # Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID
    RobotObservedPet               = 0x3d # Anki.Cozmo.ExternalInterface.RobotObservedPet
    RobotObservedMotion            = 0x3e # Anki.Cozmo.ExternalInterface.RobotObservedMotion
    RobotDeletedFace               = 0x3f # Anki.Cozmo.ExternalInterface.RobotDeletedFace
    RobotDeletedObject             = 0x40 # Anki.Cozmo.ExternalInterface.RobotDeletedObject
    RobotDeletedAllObjects         = 0x41 # Anki.Cozmo.ExternalInterface.RobotDeletedAllObjects
    RobotDeletedAllCustomObjects   = 0x42 # Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects
    CreatedFixedCustomObject       = 0x43 # Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject
    DefinedCustomObject            = 0x44 # Anki.Cozmo.ExternalInterface.DefinedCustomObject
    RobotMarkedObjectPoseUnknown   = 0x45 # Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown
    ObjectStates                   = 0x46 # Anki.Cozmo.ExternalInterface.ObjectStates
    RobotReadToolCode              = 0x47 # Anki.Cozmo.ExternalInterface.RobotReadToolCode
    FaceEnrollmentCompleted        = 0x48 # Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted
    RobotErasedEnrolledFace        = 0x49 # Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace
    RobotErasedAllEnrolledFaces    = 0x4a # Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces
    RobotCompletedFactoryDotTest   = 0x4b # Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest
    RobotCompletedAction           = 0x4c # Anki.Cozmo.ExternalInterface.RobotCompletedAction
    BlockPickedUp                  = 0x4d # Anki.Cozmo.ExternalInterface.BlockPickedUp
    BlockPlaced                    = 0x4e # Anki.Cozmo.ExternalInterface.BlockPlaced
    AnimationAvailable             = 0x4f # Anki.Cozmo.ExternalInterface.AnimationAvailable
    AnimationGroupAvailable        = 0x50 # Anki.Cozmo.ExternalInterface.AnimationGroupAvailable
    AnimationAborted               = 0x51 # Anki.Cozmo.ExternalInterface.AnimationAborted
    AnimationEvent                 = 0x52 # Anki.Cozmo.ExternalInterface.AnimationEvent
    MoodState                      = 0x53 # Anki.Cozmo.ExternalInterface.MoodState
    RequestSetUnlockResult         = 0x54 # Anki.Cozmo.ExternalInterface.RequestSetUnlockResult
    UnlockStatus                   = 0x55 # Anki.Cozmo.ExternalInterface.UnlockStatus
    UnlockedDefaults               = 0x56 # Anki.Cozmo.ExternalInterface.UnlockedDefaults
    InitDebugConsoleVarMessage     = 0x57 # Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage
    JsonDasLogMessage              = 0x58 # Anki.Cozmo.ExternalInterface.JsonDasLogMessage
    JsonDasLogAllSentMessage       = 0x59 # Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage
    VerifyDebugConsoleFuncMessage  = 0x5a # Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage
    VerifyDebugConsoleVarMessage   = 0x5b # Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage
    DebugAppendConsoleLogLine      = 0x5c # Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine
    LatencyMessage                 = 0x5d # Anki.Cozmo.ExternalInterface.LatencyMessage
    DeviceDataMessage              = 0x5e # Anki.Cozmo.ExternalInterface.DeviceDataMessage
    BlockTapFilterStatus           = 0x5f # Anki.Cozmo.ExternalInterface.BlockTapFilterStatus
    UpdateEngineState              = 0x60 # Anki.Cozmo.ExternalInterface.UpdateEngineState
    EngineErrorCodeMessage         = 0x61 # Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage
    CubeLightsStateTransition      = 0x62 # Anki.Cozmo.ExternalInterface.CubeLightsStateTransition
    BlockPoolDataMessage           = 0x63 # Anki.Cozmo.ExternalInterface.BlockPoolDataMessage
    NVStorageOpResult              = 0x64 # Anki.Cozmo.ExternalInterface.NVStorageOpResult
    FirmwareUpdateProgress         = 0x65 # Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress
    FirmwareUpdateComplete         = 0x66 # Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete
    RequestGameStart               = 0x67 # Anki.Cozmo.ExternalInterface.RequestGameStart
    SparkEnded                     = 0x68 # Anki.Cozmo.ExternalInterface.SparkEnded
    SdkConnectionStatus            = 0x69 # Anki.Cozmo.ExternalInterface.SdkConnectionStatus
    SdkStatus                      = 0x6a # Anki.Cozmo.ExternalInterface.SdkStatus
    BehaviorTransition             = 0x6b # Anki.Cozmo.ExternalInterface.BehaviorTransition
    ReactionaryBehaviorTransition  = 0x6c # Anki.Cozmo.ExternalInterface.ReactionaryBehaviorTransition
    RespondEnabledBehaviorList     = 0x6d # Anki.Cozmo.ExternalInterface.RespondEnabledBehaviorList
    BehaviorObjectiveAchieved      = 0x6e # Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved
    BuildPyramidPreReqsChanged     = 0x6f # Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged
    OnboardingState                = 0x70 # Anki.Cozmo.ExternalInterface.OnboardingState
    MemoryMapMessageBegin          = 0x71 # Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin
    MemoryMapMessage               = 0x72 # Anki.Cozmo.ExternalInterface.MemoryMapMessage
    MemoryMapMessageEnd            = 0x73 # Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd
    SupportInfo                    = 0x74 # Anki.Cozmo.ExternalInterface.SupportInfo
    EndOfMessage                   = 0x75 # Anki.Cozmo.ExternalInterface.EndOfMessage
  ...
  _tags_by_name = dict(
    ...
    ObjectTappedFiltered=12,
    ObjectTapped=13,
    ObjectPowerLevel=14,
    ObjectAccel=15,
    FactoryTestResultEntry=16,
    ImageChunk=17,
    ImageImuData=18,
    CameraCalibration=19,
    IMURequest=20,
    LoadedKnownFace=21,
    ...
    SetBodyRadioMode=29,
    AnimationState=30,
    UiDeviceAvailable=31,
    RobotConnectionResponse=32,
    RobotDisconnected=33,
    EngineRobotCLADVersionMismatch=34,
    ObjectAvailable=35,
    ObjectUnavailable=36,
    FeatureToggles=37,
    GoingToSleep=38,
    EngineLoadingDataStatus=39,
    CurrentCameraParams=40,
    PerRobotSettings=41,
    RobotState=42,
    RobotDelocalized=43,
    RobotPoked=44,
    RobotStopped=45,
    RobotOffTreadsStateChanged=46,
    RobotCliffEventFinished=47,
    RobotOnChargerPlatformEvent=48,
    ChargerEvent=49,
    UnexpectedMovement=50,
    RestoreRobotStatus=51,
    RestoreRobotOptions=52,
    DebugString=53,
    DebugAnimationString=54,
    RobotProcessedImage=55,
    RobotObservedObject=56,
    RobotObservedPossibleObject=57,
    ObjectProjectsIntoFOV=58,
    RobotObservedFace=59,
    RobotChangedObservedFaceID=60,
    RobotObservedPet=61,
    RobotObservedMotion=62,
    RobotDeletedFace=63,
    RobotDeletedObject=64,
    RobotDeletedAllObjects=65,
    RobotDeletedAllCustomObjects=66,
    CreatedFixedCustomObject=67,
    DefinedCustomObject=68,
    RobotMarkedObjectPoseUnknown=69,
    ObjectStates=70,
    RobotReadToolCode=71,
    FaceEnrollmentCompleted=72,
    RobotErasedEnrolledFace=73,
    RobotErasedAllEnrolledFaces=74,
    RobotCompletedFactoryDotTest=75,
    RobotCompletedAction=76,
    BlockPickedUp=77,
    BlockPlaced=78,
    AnimationAvailable=79,
    AnimationGroupAvailable=80,
    AnimationAborted=81,
    AnimationEvent=82,
    MoodState=83,
    RequestSetUnlockResult=84,
    UnlockStatus=85,
    UnlockedDefaults=86,
    InitDebugConsoleVarMessage=87,
    JsonDasLogMessage=88,
    JsonDasLogAllSentMessage=89,
    VerifyDebugConsoleFuncMessage=90,
    VerifyDebugConsoleVarMessage=91,
    DebugAppendConsoleLogLine=92,
    LatencyMessage=93,
    DeviceDataMessage=94,
    BlockTapFilterStatus=95,
    UpdateEngineState=96,
    EngineErrorCodeMessage=97,
    CubeLightsStateTransition=98,
    BlockPoolDataMessage=99,
    NVStorageOpResult=100,
    FirmwareUpdateProgress=101,
    FirmwareUpdateComplete=102,
    RequestGameStart=103,
    SparkEnded=104,
    SdkConnectionStatus=105,
    SdkStatus=106,
    BehaviorTransition=107,
    ReactionaryBehaviorTransition=108,
    RespondEnabledBehaviorList=109,
    BehaviorObjectiveAchieved=110,
    BuildPyramidPreReqsChanged=111,
    OnboardingState=112,
    MemoryMapMessageBegin=113,
    MemoryMapMessage=114,
    MemoryMapMessageEnd=115,
    SupportInfo=116,
    EndOfMessage=117,
  )
  ...
  _tags_by_value[12] = 'ObjectTappedFiltered'
  _tags_by_value[13] = 'ObjectTapped'
  _tags_by_value[14] = 'ObjectPowerLevel'
  _tags_by_value[15] = 'ObjectAccel'
  _tags_by_value[16] = 'FactoryTestResultEntry'
  _tags_by_value[17] = 'ImageChunk'
  _tags_by_value[18] = 'ImageImuData'
  _tags_by_value[19] = 'CameraCalibration'
  _tags_by_value[20] = 'IMURequest'
  _tags_by_value[21] = 'LoadedKnownFace'
  _tags_by_value[22] = 'RobotRenamedEnrolledFace'
  _tags_by_value[23] = 'MotorCalibration'
  _tags_by_value[24] = 'MotorAutoEnabled'
  _tags_by_value[25] = 'CliffEvent'
  _tags_by_value[26] = 'PotentialCliff'
  _tags_by_value[27] = 'ProxObstacle'
  _tags_by_value[28] = 'CarryStateUpdate'
  _tags_by_value[29] = 'SetBodyRadioMode'
  _tags_by_value[30] = 'AnimationState'
  _tags_by_value[31] = 'UiDeviceAvailable'
  _tags_by_value[32] = 'RobotConnectionResponse'
  _tags_by_value[33] = 'RobotDisconnected'
  _tags_by_value[34] = 'EngineRobotCLADVersionMismatch'
  _tags_by_value[35] = 'ObjectAvailable'
  _tags_by_value[36] = 'ObjectUnavailable'
  _tags_by_value[37] = 'FeatureToggles'
  _tags_by_value[38] = 'GoingToSleep'
  _tags_by_value[39] = 'EngineLoadingDataStatus'
  _tags_by_value[40] = 'CurrentCameraParams'
  _tags_by_value[41] = 'PerRobotSettings'
  _tags_by_value[42] = 'RobotState'
  _tags_by_value[43] = 'RobotDelocalized'
  _tags_by_value[44] = 'RobotPoked'
  _tags_by_value[45] = 'RobotStopped'
  _tags_by_value[46] = 'RobotOffTreadsStateChanged'
  _tags_by_value[47] = 'RobotCliffEventFinished'
  _tags_by_value[48] = 'RobotOnChargerPlatformEvent'
  _tags_by_value[49] = 'ChargerEvent'
  _tags_by_value[50] = 'UnexpectedMovement'
  _tags_by_value[51] = 'RestoreRobotStatus'
  _tags_by_value[52] = 'RestoreRobotOptions'
  _tags_by_value[53] = 'DebugString'
  _tags_by_value[54] = 'DebugAnimationString'
  _tags_by_value[55] = 'RobotProcessedImage'
  _tags_by_value[56] = 'RobotObservedObject'
  _tags_by_value[57] = 'RobotObservedPossibleObject'
  _tags_by_value[58] = 'ObjectProjectsIntoFOV'
  _tags_by_value[59] = 'RobotObservedFace'
  _tags_by_value[60] = 'RobotChangedObservedFaceID'
  _tags_by_value[61] = 'RobotObservedPet'
  _tags_by_value[62] = 'RobotObservedMotion'
  _tags_by_value[63] = 'RobotDeletedFace'
  _tags_by_value[64] = 'RobotDeletedObject'
  _tags_by_value[65] = 'RobotDeletedAllObjects'
  _tags_by_value[66] = 'RobotDeletedAllCustomObjects'
  _tags_by_value[67] = 'CreatedFixedCustomObject'
  _tags_by_value[68] = 'DefinedCustomObject'
  _tags_by_value[69] = 'RobotMarkedObjectPoseUnknown'
  _tags_by_value[70] = 'ObjectStates'
  _tags_by_value[71] = 'RobotReadToolCode'
  _tags_by_value[72] = 'FaceEnrollmentCompleted'
  _tags_by_value[73] = 'RobotErasedEnrolledFace'
  _tags_by_value[74] = 'RobotErasedAllEnrolledFaces'
  _tags_by_value[75] = 'RobotCompletedFactoryDotTest'
  _tags_by_value[76] = 'RobotCompletedAction'
  _tags_by_value[77] = 'BlockPickedUp'
  _tags_by_value[78] = 'BlockPlaced'
  _tags_by_value[79] = 'AnimationAvailable'
  _tags_by_value[80] = 'AnimationGroupAvailable'
  _tags_by_value[81] = 'AnimationAborted'
  _tags_by_value[82] = 'AnimationEvent'
  _tags_by_value[83] = 'MoodState'
  _tags_by_value[84] = 'RequestSetUnlockResult'
  _tags_by_value[85] = 'UnlockStatus'
  _tags_by_value[86] = 'UnlockedDefaults'
  _tags_by_value[87] = 'InitDebugConsoleVarMessage'
  _tags_by_value[88] = 'JsonDasLogMessage'
  _tags_by_value[89] = 'JsonDasLogAllSentMessage'
  _tags_by_value[90] = 'VerifyDebugConsoleFuncMessage'
  _tags_by_value[91] = 'VerifyDebugConsoleVarMessage'
  _tags_by_value[92] = 'DebugAppendConsoleLogLine'
  _tags_by_value[93] = 'LatencyMessage'
  _tags_by_value[94] = 'DeviceDataMessage'
  _tags_by_value[95] = 'BlockTapFilterStatus'
  _tags_by_value[96] = 'UpdateEngineState'
  _tags_by_value[97] = 'EngineErrorCodeMessage'
  _tags_by_value[98] = 'CubeLightsStateTransition'
  _tags_by_value[99] = 'BlockPoolDataMessage'
  _tags_by_value[100] = 'NVStorageOpResult'
  _tags_by_value[101] = 'FirmwareUpdateProgress'
  _tags_by_value[102] = 'FirmwareUpdateComplete'
  _tags_by_value[103] = 'RequestGameStart'
  _tags_by_value[104] = 'SparkEnded'
  _tags_by_value[105] = 'SdkConnectionStatus'
  _tags_by_value[106] = 'SdkStatus'
  _tags_by_value[107] = 'BehaviorTransition'
  _tags_by_value[108] = 'ReactionaryBehaviorTransition'
  _tags_by_value[109] = 'RespondEnabledBehaviorList'
  _tags_by_value[110] = 'BehaviorObjectiveAchieved'
  _tags_by_value[111] = 'BuildPyramidPreReqsChanged'
  _tags_by_value[112] = 'OnboardingState'
  _tags_by_value[113] = 'MemoryMapMessageBegin'
  _tags_by_value[114] = 'MemoryMapMessage'
  _tags_by_value[115] = 'MemoryMapMessageEnd'
  _tags_by_value[116] = 'SupportInfo'
  _tags_by_value[117] = 'EndOfMessage'
  ...
  _tag_unpack_methods[12] = lambda reader: reader.read_object(Anki.Cozmo.ObjectTappedFiltered.unpack_from)
  _tag_unpack_methods[13] = lambda reader: reader.read_object(Anki.Cozmo.ObjectTapped.unpack_from)
  _tag_unpack_methods[14] = lambda reader: reader.read_object(Anki.Cozmo.ObjectPowerLevel.unpack_from)
  _tag_unpack_methods[15] = lambda reader: reader.read_object(Anki.Cozmo.ObjectAccel.unpack_from)
  _tag_unpack_methods[16] = lambda reader: reader.read_object(Anki.Cozmo.FactoryTestResultEntry.unpack_from)
  _tag_unpack_methods[17] = lambda reader: reader.read_object(Anki.Cozmo.ImageChunk.unpack_from)
  _tag_unpack_methods[18] = lambda reader: reader.read_object(Anki.Cozmo.ImageImuData.unpack_from)
  _tag_unpack_methods[19] = lambda reader: reader.read_object(Anki.Cozmo.CameraCalibration.unpack_from)
  _tag_unpack_methods[20] = lambda reader: reader.read_object(Anki.Cozmo.IMURequest.unpack_from)
  _tag_unpack_methods[21] = lambda reader: reader.read_object(Anki.Vision.LoadedKnownFace.unpack_from)
  _tag_unpack_methods[22] = lambda reader: reader.read_object(Anki.Vision.RobotRenamedEnrolledFace.unpack_from)
  _tag_unpack_methods[23] = lambda reader: reader.read_object(Anki.Cozmo.MotorCalibration.unpack_from)
  _tag_unpack_methods[24] = lambda reader: reader.read_object(Anki.Cozmo.MotorAutoEnabled.unpack_from)
  _tag_unpack_methods[25] = lambda reader: reader.read_object(Anki.Cozmo.CliffEvent.unpack_from)
  _tag_unpack_methods[26] = lambda reader: reader.read_object(Anki.Cozmo.PotentialCliff.unpack_from)
  _tag_unpack_methods[27] = lambda reader: reader.read_object(Anki.Cozmo.ProxObstacle.unpack_from)
  _tag_unpack_methods[28] = lambda reader: reader.read_object(Anki.Cozmo.CarryStateUpdate.unpack_from)
  _tag_unpack_methods[29] = lambda reader: reader.read_object(Anki.Cozmo.SetBodyRadioMode.unpack_from)
  _tag_unpack_methods[30] = lambda reader: reader.read_object(Anki.Cozmo.RobotInterface.AnimationState.unpack_from)
  _tag_unpack_methods[31] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UiDeviceAvailable.unpack_from)
  _tag_unpack_methods[32] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotConnectionResponse.unpack_from)
  _tag_unpack_methods[33] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDisconnected.unpack_from)
  _tag_unpack_methods[34] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EngineRobotCLADVersionMismatch.unpack_from)
  _tag_unpack_methods[35] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ObjectAvailable.unpack_from)
  _tag_unpack_methods[36] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ObjectUnavailable.unpack_from)
  _tag_unpack_methods[37] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FeatureToggles.unpack_from)
  _tag_unpack_methods[38] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GoingToSleep.unpack_from)
  _tag_unpack_methods[39] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EngineLoadingDataStatus.unpack_from)
  _tag_unpack_methods[40] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CurrentCameraParams.unpack_from)
  _tag_unpack_methods[41] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PerRobotSettings.unpack_from)
  _tag_unpack_methods[42] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotState.unpack_from)
  _tag_unpack_methods[43] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDelocalized.unpack_from)
  _tag_unpack_methods[44] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotPoked.unpack_from)
  _tag_unpack_methods[45] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotStopped.unpack_from)
  _tag_unpack_methods[46] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotOffTreadsStateChanged.unpack_from)
  _tag_unpack_methods[47] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCliffEventFinished.unpack_from)
  _tag_unpack_methods[48] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotOnChargerPlatformEvent.unpack_from)
  _tag_unpack_methods[49] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ChargerEvent.unpack_from)
  _tag_unpack_methods[50] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnexpectedMovement.unpack_from)
  _tag_unpack_methods[51] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RestoreRobotStatus.unpack_from)
  _tag_unpack_methods[52] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RestoreRobotOptions.unpack_from)
  _tag_unpack_methods[53] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugString.unpack_from)
  _tag_unpack_methods[54] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugAnimationString.unpack_from)
  _tag_unpack_methods[55] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotProcessedImage.unpack_from)
  _tag_unpack_methods[56] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedObject.unpack_from)
  _tag_unpack_methods[57] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject.unpack_from)
  _tag_unpack_methods[58] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ObjectProjectsIntoFOV.unpack_from)
  _tag_unpack_methods[59] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedFace.unpack_from)
  _tag_unpack_methods[60] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID.unpack_from)
  _tag_unpack_methods[61] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedPet.unpack_from)
  _tag_unpack_methods[62] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedMotion.unpack_from)
  _tag_unpack_methods[63] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedFace.unpack_from)
  _tag_unpack_methods[64] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedObject.unpack_from)
  _tag_unpack_methods[65] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedAllObjects.unpack_from)
  _tag_unpack_methods[66] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects.unpack_from)
  _tag_unpack_methods[67] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject.unpack_from)
  _tag_unpack_methods[68] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefinedCustomObject.unpack_from)
  _tag_unpack_methods[69] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown.unpack_from)
  _tag_unpack_methods[70] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ObjectStates.unpack_from)
  _tag_unpack_methods[71] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotReadToolCode.unpack_from)
  _tag_unpack_methods[72] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted.unpack_from)
  _tag_unpack_methods[73] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace.unpack_from)
  _tag_unpack_methods[74] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces.unpack_from)
  _tag_unpack_methods[75] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest.unpack_from)
  _tag_unpack_methods[76] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCompletedAction.unpack_from)
  _tag_unpack_methods[77] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPickedUp.unpack_from)
  _tag_unpack_methods[78] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPlaced.unpack_from)
  _tag_unpack_methods[79] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationAvailable.unpack_from)
  _tag_unpack_methods[80] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationGroupAvailable.unpack_from)
  _tag_unpack_methods[81] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationAborted.unpack_from)
  _tag_unpack_methods[82] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationEvent.unpack_from)
  _tag_unpack_methods[83] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoodState.unpack_from)
  _tag_unpack_methods[84] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestSetUnlockResult.unpack_from)
  _tag_unpack_methods[85] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnlockStatus.unpack_from)
  _tag_unpack_methods[86] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnlockedDefaults.unpack_from)
  _tag_unpack_methods[87] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[88] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.JsonDasLogMessage.unpack_from)
  _tag_unpack_methods[89] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage.unpack_from)
  _tag_unpack_methods[90] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage.unpack_from)
  _tag_unpack_methods[91] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[92] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine.unpack_from)
  _tag_unpack_methods[93] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LatencyMessage.unpack_from)
  _tag_unpack_methods[94] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeviceDataMessage.unpack_from)
  _tag_unpack_methods[95] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockTapFilterStatus.unpack_from)
  _tag_unpack_methods[96] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateEngineState.unpack_from)
  _tag_unpack_methods[97] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage.unpack_from)
  _tag_unpack_methods[98] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CubeLightsStateTransition.unpack_from)
  _tag_unpack_methods[99] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolDataMessage.unpack_from)
  _tag_unpack_methods[100] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageOpResult.unpack_from)
  _tag_unpack_methods[101] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress.unpack_from)
  _tag_unpack_methods[102] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete.unpack_from)
  _tag_unpack_methods[103] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestGameStart.unpack_from)
  _tag_unpack_methods[104] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SparkEnded.unpack_from)
  _tag_unpack_methods[105] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SdkConnectionStatus.unpack_from)
  _tag_unpack_methods[106] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SdkStatus.unpack_from)
  _tag_unpack_methods[107] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorTransition.unpack_from)
  _tag_unpack_methods[108] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReactionaryBehaviorTransition.unpack_from)
  _tag_unpack_methods[109] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RespondEnabledBehaviorList.unpack_from)
  _tag_unpack_methods[110] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved.unpack_from)
  _tag_unpack_methods[111] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged.unpack_from)
  _tag_unpack_methods[112] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.OnboardingState.unpack_from)
  _tag_unpack_methods[113] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin.unpack_from)
  _tag_unpack_methods[114] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessage.unpack_from)
  _tag_unpack_methods[115] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd.unpack_from)
  _tag_unpack_methods[116] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SupportInfo.unpack_from)
  _tag_unpack_methods[117] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EndOfMessage.unpack_from)
  ...
  _type_by_tag_value[12] = lambda : Anki.Cozmo.ObjectTappedFiltered
  _type_by_tag_value[13] = lambda : Anki.Cozmo.ObjectTapped
  _type_by_tag_value[14] = lambda : Anki.Cozmo.ObjectPowerLevel
  _type_by_tag_value[15] = lambda : Anki.Cozmo.ObjectAccel
  _type_by_tag_value[16] = lambda : Anki.Cozmo.FactoryTestResultEntry
  _type_by_tag_value[17] = lambda : Anki.Cozmo.ImageChunk
  _type_by_tag_value[18] = lambda : Anki.Cozmo.ImageImuData
  _type_by_tag_value[19] = lambda : Anki.Cozmo.CameraCalibration
  _type_by_tag_value[20] = lambda : Anki.Cozmo.IMURequest
  _type_by_tag_value[21] = lambda : Anki.Vision.LoadedKnownFace
  _type_by_tag_value[22] = lambda : Anki.Vision.RobotRenamedEnrolledFace
  _type_by_tag_value[23] = lambda : Anki.Cozmo.MotorCalibration
  _type_by_tag_value[24] = lambda : Anki.Cozmo.MotorAutoEnabled
  _type_by_tag_value[25] = lambda : Anki.Cozmo.CliffEvent
  _type_by_tag_value[26] = lambda : Anki.Cozmo.PotentialCliff
  _type_by_tag_value[27] = lambda : Anki.Cozmo.ProxObstacle
  _type_by_tag_value[28] = lambda : Anki.Cozmo.CarryStateUpdate
  _type_by_tag_value[29] = lambda : Anki.Cozmo.SetBodyRadioMode
  _type_by_tag_value[30] = lambda : Anki.Cozmo.RobotInterface.AnimationState
  _type_by_tag_value[31] = lambda : Anki.Cozmo.ExternalInterface.UiDeviceAvailable
  _type_by_tag_value[32] = lambda : Anki.Cozmo.ExternalInterface.RobotConnectionResponse
  _type_by_tag_value[33] = lambda : Anki.Cozmo.ExternalInterface.RobotDisconnected
  _type_by_tag_value[34] = lambda : Anki.Cozmo.ExternalInterface.EngineRobotCLADVersionMismatch
  _type_by_tag_value[35] = lambda : Anki.Cozmo.ExternalInterface.ObjectAvailable
  _type_by_tag_value[36] = lambda : Anki.Cozmo.ExternalInterface.ObjectUnavailable
  _type_by_tag_value[37] = lambda : Anki.Cozmo.ExternalInterface.FeatureToggles
  _type_by_tag_value[38] = lambda : Anki.Cozmo.ExternalInterface.GoingToSleep
  _type_by_tag_value[39] = lambda : Anki.Cozmo.ExternalInterface.EngineLoadingDataStatus
  _type_by_tag_value[40] = lambda : Anki.Cozmo.ExternalInterface.CurrentCameraParams
  _type_by_tag_value[41] = lambda : Anki.Cozmo.ExternalInterface.PerRobotSettings
  _type_by_tag_value[42] = lambda : Anki.Cozmo.ExternalInterface.RobotState
  _type_by_tag_value[43] = lambda : Anki.Cozmo.ExternalInterface.RobotDelocalized
  _type_by_tag_value[44] = lambda : Anki.Cozmo.ExternalInterface.RobotPoked
  _type_by_tag_value[45] = lambda : Anki.Cozmo.ExternalInterface.RobotStopped
  _type_by_tag_value[46] = lambda : Anki.Cozmo.ExternalInterface.RobotOffTreadsStateChanged
  _type_by_tag_value[47] = lambda : Anki.Cozmo.ExternalInterface.RobotCliffEventFinished
  _type_by_tag_value[48] = lambda : Anki.Cozmo.ExternalInterface.RobotOnChargerPlatformEvent
  _type_by_tag_value[49] = lambda : Anki.Cozmo.ExternalInterface.ChargerEvent
  _type_by_tag_value[50] = lambda : Anki.Cozmo.ExternalInterface.UnexpectedMovement
  _type_by_tag_value[51] = lambda : Anki.Cozmo.ExternalInterface.RestoreRobotStatus
  _type_by_tag_value[52] = lambda : Anki.Cozmo.ExternalInterface.RestoreRobotOptions
  _type_by_tag_value[53] = lambda : Anki.Cozmo.ExternalInterface.DebugString
  _type_by_tag_value[54] = lambda : Anki.Cozmo.ExternalInterface.DebugAnimationString
  _type_by_tag_value[55] = lambda : Anki.Cozmo.ExternalInterface.RobotProcessedImage
  _type_by_tag_value[56] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedObject
  _type_by_tag_value[57] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject
  _type_by_tag_value[58] = lambda : Anki.Cozmo.ExternalInterface.ObjectProjectsIntoFOV
  _type_by_tag_value[59] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedFace
  _type_by_tag_value[60] = lambda : Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID
  _type_by_tag_value[61] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedPet
  _type_by_tag_value[62] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedMotion
  _type_by_tag_value[63] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedFace
  _type_by_tag_value[64] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedObject
  _type_by_tag_value[65] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedAllObjects
  _type_by_tag_value[66] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects
  _type_by_tag_value[67] = lambda : Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject
  _type_by_tag_value[68] = lambda : Anki.Cozmo.ExternalInterface.DefinedCustomObject
  _type_by_tag_value[69] = lambda : Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown
  _type_by_tag_value[70] = lambda : Anki.Cozmo.ExternalInterface.ObjectStates
  _type_by_tag_value[71] = lambda : Anki.Cozmo.ExternalInterface.RobotReadToolCode
  _type_by_tag_value[72] = lambda : Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted
  _type_by_tag_value[73] = lambda : Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace
  _type_by_tag_value[74] = lambda : Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces
  _type_by_tag_value[75] = lambda : Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest
  _type_by_tag_value[76] = lambda : Anki.Cozmo.ExternalInterface.RobotCompletedAction
  _type_by_tag_value[77] = lambda : Anki.Cozmo.ExternalInterface.BlockPickedUp
  _type_by_tag_value[78] = lambda : Anki.Cozmo.ExternalInterface.BlockPlaced
  _type_by_tag_value[79] = lambda : Anki.Cozmo.ExternalInterface.AnimationAvailable
  _type_by_tag_value[80] = lambda : Anki.Cozmo.ExternalInterface.AnimationGroupAvailable
  _type_by_tag_value[81] = lambda : Anki.Cozmo.ExternalInterface.AnimationAborted
  _type_by_tag_value[82] = lambda : Anki.Cozmo.ExternalInterface.AnimationEvent
  _type_by_tag_value[83] = lambda : Anki.Cozmo.ExternalInterface.MoodState
  _type_by_tag_value[84] = lambda : Anki.Cozmo.ExternalInterface.RequestSetUnlockResult
  _type_by_tag_value[85] = lambda : Anki.Cozmo.ExternalInterface.UnlockStatus
  _type_by_tag_value[86] = lambda : Anki.Cozmo.ExternalInterface.UnlockedDefaults
  _type_by_tag_value[87] = lambda : Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage
  _type_by_tag_value[88] = lambda : Anki.Cozmo.ExternalInterface.JsonDasLogMessage
  _type_by_tag_value[89] = lambda : Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage
  _type_by_tag_value[90] = lambda : Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage
  _type_by_tag_value[91] = lambda : Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage
  _type_by_tag_value[92] = lambda : Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine
  _type_by_tag_value[93] = lambda : Anki.Cozmo.ExternalInterface.LatencyMessage
  _type_by_tag_value[94] = lambda : Anki.Cozmo.ExternalInterface.DeviceDataMessage
  _type_by_tag_value[95] = lambda : Anki.Cozmo.ExternalInterface.BlockTapFilterStatus
  _type_by_tag_value[96] = lambda : Anki.Cozmo.ExternalInterface.UpdateEngineState
  _type_by_tag_value[97] = lambda : Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage
  _type_by_tag_value[98] = lambda : Anki.Cozmo.ExternalInterface.CubeLightsStateTransition
  _type_by_tag_value[99] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolDataMessage
  _type_by_tag_value[100] = lambda : Anki.Cozmo.ExternalInterface.NVStorageOpResult
  _type_by_tag_value[101] = lambda : Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress
  _type_by_tag_value[102] = lambda : Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete
  _type_by_tag_value[103] = lambda : Anki.Cozmo.ExternalInterface.RequestGameStart
  _type_by_tag_value[104] = lambda : Anki.Cozmo.ExternalInterface.SparkEnded
  _type_by_tag_value[105] = lambda : Anki.Cozmo.ExternalInterface.SdkConnectionStatus
  _type_by_tag_value[106] = lambda : Anki.Cozmo.ExternalInterface.SdkStatus
  _type_by_tag_value[107] = lambda : Anki.Cozmo.ExternalInterface.BehaviorTransition
  _type_by_tag_value[108] = lambda : Anki.Cozmo.ExternalInterface.ReactionaryBehaviorTransition
  _type_by_tag_value[109] = lambda : Anki.Cozmo.ExternalInterface.RespondEnabledBehaviorList
  _type_by_tag_value[110] = lambda : Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved
  _type_by_tag_value[111] = lambda : Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged
  _type_by_tag_value[112] = lambda : Anki.Cozmo.ExternalInterface.OnboardingState
  _type_by_tag_value[113] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin
  _type_by_tag_value[114] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessage
  _type_by_tag_value[115] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd
  _type_by_tag_value[116] = lambda : Anki.Cozmo.ExternalInterface.SupportInfo
  _type_by_tag_value[117] = lambda : Anki.Cozmo.ExternalInterface.EndOfMessage
