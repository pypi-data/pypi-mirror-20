...
class MessageGameToEngine(object):
  ...
  class Tag(object):
    ...
    ClearAllBlocks                          = 0x6d # Anki.Cozmo.ExternalInterface.ClearAllBlocks
    ClearAllObjects                         = 0x6e # Anki.Cozmo.ExternalInterface.ClearAllObjects
    DeleteAllObjects                        = 0x6f # Anki.Cozmo.ExternalInterface.DeleteAllObjects
    DeleteAllCustomObjects                  = 0x70 # Anki.Cozmo.ExternalInterface.DeleteAllCustomObjects
    CreateFixedCustomObject                 = 0x71 # Anki.Cozmo.ExternalInterface.CreateFixedCustomObject
    DefineCustomBox                         = 0x72 # Anki.Cozmo.ExternalInterface.DefineCustomBox
    DefineCustomCube                        = 0x73 # Anki.Cozmo.ExternalInterface.DefineCustomCube
    DefineCustomWall                        = 0x74 # Anki.Cozmo.ExternalInterface.DefineCustomWall
    SetObjectAdditionAndDeletion            = 0x75 # Anki.Cozmo.ExternalInterface.SetObjectAdditionAndDeletion
    VisionWhileMoving                       = 0x76 # Anki.Cozmo.ExternalInterface.VisionWhileMoving
    SetFaceToEnroll                         = 0x77 # Anki.Cozmo.ExternalInterface.SetFaceToEnroll
    CancelFaceEnrollment                    = 0x78 # Anki.Cozmo.ExternalInterface.CancelFaceEnrollment
    EraseEnrolledFaceByID                   = 0x79 # Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID
    EraseAllEnrolledFaces                   = 0x7a # Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces
    EnableVisionMode                        = 0x7b # Anki.Cozmo.ExternalInterface.EnableVisionMode
    UpdateEnrolledFaceByID                  = 0x7c # Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID
    VisionRunMode                           = 0x7d # Anki.Cozmo.ExternalInterface.VisionRunMode
    SaveFaceAlbumToFile                     = 0x7e # Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile
    LoadFaceAlbumFromFile                   = 0x7f # Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile
    SetMemoryMapRenderEnabled               = 0x80 # Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled
    SetMemoryMapBroadcastFrequency_sec      = 0x81 # Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec
    ActivateBehaviorChooser                 = 0x82 # Anki.Cozmo.ExternalInterface.ActivateBehaviorChooser
    ExecuteBehaviorByExecutableType         = 0x83 # Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType
    ExecuteBehaviorByName                   = 0x84 # Anki.Cozmo.ExternalInterface.ExecuteBehaviorByName
    SetLiftLoadTestAsRunnable               = 0x85 # Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable
    BehaviorManagerMessage                  = 0x86 # Anki.Cozmo.ExternalInterface.BehaviorManagerMessage
    AbortPath                               = 0x87 # Anki.Cozmo.ExternalInterface.AbortPath
    AbortAll                                = 0x88 # Anki.Cozmo.ExternalInterface.AbortAll
    StartTestMode                           = 0x89 # Anki.Cozmo.ExternalInterface.StartTestMode
    RequestEnabledBehaviorList              = 0x8a # Anki.Cozmo.ExternalInterface.RequestEnabledBehaviorList
    RequestEnableReactionTrigger            = 0x8b # Anki.Cozmo.ExternalInterface.RequestEnableReactionTrigger
    SetDefaultHeadAndLiftState              = 0x8c # Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState
    RequestObjectStates                     = 0x8d # Anki.Cozmo.ExternalInterface.RequestObjectStates
    DrawPoseMarker                          = 0x8e # Anki.Cozmo.ExternalInterface.DrawPoseMarker
    ErasePoseMarker                         = 0x8f # Anki.Cozmo.ExternalInterface.ErasePoseMarker
    VisualizeQuad                           = 0x90 # Anki.Cozmo.ExternalInterface.VisualizeQuad
    EraseQuad                               = 0x91 # Anki.Cozmo.ExternalInterface.EraseQuad
    ReplayLastAnimation                     = 0x92 # Anki.Cozmo.ExternalInterface.ReplayLastAnimation
    SetIdleAnimation                        = 0x93 # Anki.Cozmo.ExternalInterface.SetIdleAnimation
    PushIdleAnimation                       = 0x94 # Anki.Cozmo.ExternalInterface.PushIdleAnimation
    PopIdleAnimation                        = 0x95 # Anki.Cozmo.ExternalInterface.PopIdleAnimation
    ReadFaceAnimationDir                    = 0x96 # Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir
    ReadAnimationFile                       = 0x97 # Anki.Cozmo.ExternalInterface.ReadAnimationFile
    RequestAvailableAnimations              = 0x98 # Anki.Cozmo.ExternalInterface.RequestAvailableAnimations
    RequestAvailableAnimationGroups         = 0x99 # Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups
    SetLiveIdleAnimationParameters          = 0x9a # Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters
    PushDrivingAnimations                   = 0x9b # Anki.Cozmo.ExternalInterface.PushDrivingAnimations
    PopDrivingAnimations                    = 0x9c # Anki.Cozmo.ExternalInterface.PopDrivingAnimations
    SetHeadlight                            = 0x9d # Anki.Cozmo.ExternalInterface.SetHeadlight
    SetActiveObjectLEDs                     = 0x9e # Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs
    SetAllActiveObjectLEDs                  = 0x9f # Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs
    SetBackpackLEDs                         = 0xa0 # Anki.Cozmo.ExternalInterface.SetBackpackLEDs
    EnableLightStates                       = 0xa1 # Anki.Cozmo.ExternalInterface.EnableLightStates
    EnableCubeSleep                         = 0xa2 # Anki.Cozmo.ExternalInterface.EnableCubeSleep
    EnableCubeLightsStateTransitionMessages = 0xa3 # Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages
    FlashCurrentLightsState                 = 0xa4 # Anki.Cozmo.ExternalInterface.FlashCurrentLightsState
    PlayCubeAnim                            = 0xa5 # Anki.Cozmo.ExternalInterface.PlayCubeAnim
    StopCubeAnim                            = 0xa6 # Anki.Cozmo.ExternalInterface.StopCubeAnim
    StreamObjectAccel                       = 0xa7 # Anki.Cozmo.ExternalInterface.StreamObjectAccel
    TransitionToNextOnboardingState         = 0xa8 # Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState
    MoodMessage                             = 0xa9 # Anki.Cozmo.ExternalInterface.MoodMessage
    ProgressionMessage                      = 0xaa # Anki.Cozmo.ExternalInterface.ProgressionMessage
    RequestSetUnlock                        = 0xab # Anki.Cozmo.ExternalInterface.RequestSetUnlock
    RequestDeviceData                       = 0xac # Anki.Cozmo.ExternalInterface.RequestDeviceData
    SetDebugConsoleVarMessage               = 0xad # Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage
    RunDebugConsoleFuncMessage              = 0xae # Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage
    GetDebugConsoleVarMessage               = 0xaf # Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage
    GetAllDebugConsoleVarMessage            = 0xb0 # Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage
    GetJsonDasLogsMessage                   = 0xb1 # Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage
    EnableAllReactionTriggers               = 0xb2 # Anki.Cozmo.ExternalInterface.EnableAllReactionTriggers
    SetEnableSpeedChooser                   = 0xb3 # Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser
    BlockPoolEnabledMessage                 = 0xb4 # Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
    BlockSelectedMessage                    = 0xb5 # Anki.Cozmo.ExternalInterface.BlockSelectedMessage
    GetBlockPoolMessage                     = 0xb6 # Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
    SendAvailableObjects                    = 0xb7 # Anki.Cozmo.ExternalInterface.SendAvailableObjects
    BlockPoolResetMessage                   = 0xb8 # Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
    SaveCalibrationImage                    = 0xb9 # Anki.Cozmo.ExternalInterface.SaveCalibrationImage
    ClearCalibrationImages                  = 0xba # Anki.Cozmo.ExternalInterface.ClearCalibrationImages
    ComputeCameraCalibration                = 0xbb # Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
    ContinueFreeplayFromIdle                = 0xbc # Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
    EnableDroneMode                         = 0xbd # Anki.Cozmo.ExternalInterface.EnableDroneMode
    EnterSdkMode                            = 0xbe # Anki.Cozmo.ExternalInterface.EnterSdkMode
    ExitSdkMode                             = 0xbf # Anki.Cozmo.ExternalInterface.ExitSdkMode
    SetStopRobotOnSdkDisconnect             = 0xc0 # Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
    StopRobotForSdk                         = 0xc1 # Anki.Cozmo.ExternalInterface.StopRobotForSdk
    TransferFile                            = 0xc2 # Anki.Cozmo.ExternalInterface.TransferFile
    NVStorageEraseEntry                     = 0xc3 # Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
    NVStorageWipeAll                        = 0xc4 # Anki.Cozmo.ExternalInterface.NVStorageWipeAll
    NVStorageWriteEntry                     = 0xc5 # Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
    NVStorageClearPartialPendingWriteEntry  = 0xc6 # Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
    NVStorageReadEntry                      = 0xc7 # Anki.Cozmo.ExternalInterface.NVStorageReadEntry
    SetCameraSettings                       = 0xc8 # Anki.Cozmo.ExternalInterface.SetCameraSettings
    RequestRobotSettings                    = 0xc9 # Anki.Cozmo.ExternalInterface.RequestRobotSettings
  ...
  _tags_by_name = dict(
    ...
    ClearAllBlocks=109,
    ClearAllObjects=110,
    DeleteAllObjects=111,
    DeleteAllCustomObjects=112,
    CreateFixedCustomObject=113,
    DefineCustomBox=114,
    DefineCustomCube=115,
    DefineCustomWall=116,
    SetObjectAdditionAndDeletion=117,
    VisionWhileMoving=118,
    SetFaceToEnroll=119,
    CancelFaceEnrollment=120,
    EraseEnrolledFaceByID=121,
    EraseAllEnrolledFaces=122,
    EnableVisionMode=123,
    UpdateEnrolledFaceByID=124,
    VisionRunMode=125,
    SaveFaceAlbumToFile=126,
    LoadFaceAlbumFromFile=127,
    SetMemoryMapRenderEnabled=128,
    SetMemoryMapBroadcastFrequency_sec=129,
    ActivateBehaviorChooser=130,
    ExecuteBehaviorByExecutableType=131,
    ExecuteBehaviorByName=132,
    SetLiftLoadTestAsRunnable=133,
    BehaviorManagerMessage=134,
    AbortPath=135,
    AbortAll=136,
    StartTestMode=137,
    RequestEnabledBehaviorList=138,
    RequestEnableReactionTrigger=139,
    SetDefaultHeadAndLiftState=140,
    RequestObjectStates=141,
    DrawPoseMarker=142,
    ErasePoseMarker=143,
    VisualizeQuad=144,
    EraseQuad=145,
    ReplayLastAnimation=146,
    SetIdleAnimation=147,
    PushIdleAnimation=148,
    PopIdleAnimation=149,
    ReadFaceAnimationDir=150,
    ReadAnimationFile=151,
    RequestAvailableAnimations=152,
    RequestAvailableAnimationGroups=153,
    SetLiveIdleAnimationParameters=154,
    PushDrivingAnimations=155,
    PopDrivingAnimations=156,
    SetHeadlight=157,
    SetActiveObjectLEDs=158,
    SetAllActiveObjectLEDs=159,
    SetBackpackLEDs=160,
    EnableLightStates=161,
    EnableCubeSleep=162,
    EnableCubeLightsStateTransitionMessages=163,
    FlashCurrentLightsState=164,
    PlayCubeAnim=165,
    StopCubeAnim=166,
    StreamObjectAccel=167,
    TransitionToNextOnboardingState=168,
    MoodMessage=169,
    ProgressionMessage=170,
    RequestSetUnlock=171,
    RequestDeviceData=172,
    SetDebugConsoleVarMessage=173,
    RunDebugConsoleFuncMessage=174,
    GetDebugConsoleVarMessage=175,
    GetAllDebugConsoleVarMessage=176,
    GetJsonDasLogsMessage=177,
    EnableAllReactionTriggers=178,
    SetEnableSpeedChooser=179,
    BlockPoolEnabledMessage=180,
    BlockSelectedMessage=181,
    GetBlockPoolMessage=182,
    SendAvailableObjects=183,
    BlockPoolResetMessage=184,
    SaveCalibrationImage=185,
    ClearCalibrationImages=186,
    ComputeCameraCalibration=187,
    ContinueFreeplayFromIdle=188,
    EnableDroneMode=189,
    EnterSdkMode=190,
    ExitSdkMode=191,
    SetStopRobotOnSdkDisconnect=192,
    StopRobotForSdk=193,
    TransferFile=194,
    NVStorageEraseEntry=195,
    NVStorageWipeAll=196,
    NVStorageWriteEntry=197,
    NVStorageClearPartialPendingWriteEntry=198,
    NVStorageReadEntry=199,
    SetCameraSettings=200,
    RequestRobotSettings=201,
  )
  ...
  _tags_by_value[109] = 'ClearAllBlocks'
  _tags_by_value[110] = 'ClearAllObjects'
  _tags_by_value[111] = 'DeleteAllObjects'
  _tags_by_value[112] = 'DeleteAllCustomObjects'
  _tags_by_value[113] = 'CreateFixedCustomObject'
  _tags_by_value[114] = 'DefineCustomBox'
  _tags_by_value[115] = 'DefineCustomCube'
  _tags_by_value[116] = 'DefineCustomWall'
  _tags_by_value[117] = 'SetObjectAdditionAndDeletion'
  _tags_by_value[118] = 'VisionWhileMoving'
  _tags_by_value[119] = 'SetFaceToEnroll'
  _tags_by_value[120] = 'CancelFaceEnrollment'
  _tags_by_value[121] = 'EraseEnrolledFaceByID'
  _tags_by_value[122] = 'EraseAllEnrolledFaces'
  _tags_by_value[123] = 'EnableVisionMode'
  _tags_by_value[124] = 'UpdateEnrolledFaceByID'
  _tags_by_value[125] = 'VisionRunMode'
  _tags_by_value[126] = 'SaveFaceAlbumToFile'
  _tags_by_value[127] = 'LoadFaceAlbumFromFile'
  _tags_by_value[128] = 'SetMemoryMapRenderEnabled'
  _tags_by_value[129] = 'SetMemoryMapBroadcastFrequency_sec'
  _tags_by_value[130] = 'ActivateBehaviorChooser'
  _tags_by_value[131] = 'ExecuteBehaviorByExecutableType'
  _tags_by_value[132] = 'ExecuteBehaviorByName'
  _tags_by_value[133] = 'SetLiftLoadTestAsRunnable'
  _tags_by_value[134] = 'BehaviorManagerMessage'
  _tags_by_value[135] = 'AbortPath'
  _tags_by_value[136] = 'AbortAll'
  _tags_by_value[137] = 'StartTestMode'
  _tags_by_value[138] = 'RequestEnabledBehaviorList'
  _tags_by_value[139] = 'RequestEnableReactionTrigger'
  _tags_by_value[140] = 'SetDefaultHeadAndLiftState'
  _tags_by_value[141] = 'RequestObjectStates'
  _tags_by_value[142] = 'DrawPoseMarker'
  _tags_by_value[143] = 'ErasePoseMarker'
  _tags_by_value[144] = 'VisualizeQuad'
  _tags_by_value[145] = 'EraseQuad'
  _tags_by_value[146] = 'ReplayLastAnimation'
  _tags_by_value[147] = 'SetIdleAnimation'
  _tags_by_value[148] = 'PushIdleAnimation'
  _tags_by_value[149] = 'PopIdleAnimation'
  _tags_by_value[150] = 'ReadFaceAnimationDir'
  _tags_by_value[151] = 'ReadAnimationFile'
  _tags_by_value[152] = 'RequestAvailableAnimations'
  _tags_by_value[153] = 'RequestAvailableAnimationGroups'
  _tags_by_value[154] = 'SetLiveIdleAnimationParameters'
  _tags_by_value[155] = 'PushDrivingAnimations'
  _tags_by_value[156] = 'PopDrivingAnimations'
  _tags_by_value[157] = 'SetHeadlight'
  _tags_by_value[158] = 'SetActiveObjectLEDs'
  _tags_by_value[159] = 'SetAllActiveObjectLEDs'
  _tags_by_value[160] = 'SetBackpackLEDs'
  _tags_by_value[161] = 'EnableLightStates'
  _tags_by_value[162] = 'EnableCubeSleep'
  _tags_by_value[163] = 'EnableCubeLightsStateTransitionMessages'
  _tags_by_value[164] = 'FlashCurrentLightsState'
  _tags_by_value[165] = 'PlayCubeAnim'
  _tags_by_value[166] = 'StopCubeAnim'
  _tags_by_value[167] = 'StreamObjectAccel'
  _tags_by_value[168] = 'TransitionToNextOnboardingState'
  _tags_by_value[169] = 'MoodMessage'
  _tags_by_value[170] = 'ProgressionMessage'
  _tags_by_value[171] = 'RequestSetUnlock'
  _tags_by_value[172] = 'RequestDeviceData'
  _tags_by_value[173] = 'SetDebugConsoleVarMessage'
  _tags_by_value[174] = 'RunDebugConsoleFuncMessage'
  _tags_by_value[175] = 'GetDebugConsoleVarMessage'
  _tags_by_value[176] = 'GetAllDebugConsoleVarMessage'
  _tags_by_value[177] = 'GetJsonDasLogsMessage'
  _tags_by_value[178] = 'EnableAllReactionTriggers'
  _tags_by_value[179] = 'SetEnableSpeedChooser'
  _tags_by_value[180] = 'BlockPoolEnabledMessage'
  _tags_by_value[181] = 'BlockSelectedMessage'
  _tags_by_value[182] = 'GetBlockPoolMessage'
  _tags_by_value[183] = 'SendAvailableObjects'
  _tags_by_value[184] = 'BlockPoolResetMessage'
  _tags_by_value[185] = 'SaveCalibrationImage'
  _tags_by_value[186] = 'ClearCalibrationImages'
  _tags_by_value[187] = 'ComputeCameraCalibration'
  _tags_by_value[188] = 'ContinueFreeplayFromIdle'
  _tags_by_value[189] = 'EnableDroneMode'
  _tags_by_value[190] = 'EnterSdkMode'
  _tags_by_value[191] = 'ExitSdkMode'
  _tags_by_value[192] = 'SetStopRobotOnSdkDisconnect'
  _tags_by_value[193] = 'StopRobotForSdk'
  _tags_by_value[194] = 'TransferFile'
  _tags_by_value[195] = 'NVStorageEraseEntry'
  _tags_by_value[196] = 'NVStorageWipeAll'
  _tags_by_value[197] = 'NVStorageWriteEntry'
  _tags_by_value[198] = 'NVStorageClearPartialPendingWriteEntry'
  _tags_by_value[199] = 'NVStorageReadEntry'
  _tags_by_value[200] = 'SetCameraSettings'
  _tags_by_value[201] = 'RequestRobotSettings'
  ...
  _tag_unpack_methods[109] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ClearAllBlocks.unpack_from)
  _tag_unpack_methods[110] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ClearAllObjects.unpack_from)
  _tag_unpack_methods[111] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeleteAllObjects.unpack_from)
  _tag_unpack_methods[112] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeleteAllCustomObjects.unpack_from)
  _tag_unpack_methods[113] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CreateFixedCustomObject.unpack_from)
  _tag_unpack_methods[114] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefineCustomBox.unpack_from)
  _tag_unpack_methods[115] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefineCustomCube.unpack_from)
  _tag_unpack_methods[116] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefineCustomWall.unpack_from)
  _tag_unpack_methods[117] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetObjectAdditionAndDeletion.unpack_from)
  _tag_unpack_methods[118] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisionWhileMoving.unpack_from)
  _tag_unpack_methods[119] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetFaceToEnroll.unpack_from)
  _tag_unpack_methods[120] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CancelFaceEnrollment.unpack_from)
  _tag_unpack_methods[121] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID.unpack_from)
  _tag_unpack_methods[122] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces.unpack_from)
  _tag_unpack_methods[123] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableVisionMode.unpack_from)
  _tag_unpack_methods[124] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID.unpack_from)
  _tag_unpack_methods[125] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisionRunMode.unpack_from)
  _tag_unpack_methods[126] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile.unpack_from)
  _tag_unpack_methods[127] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile.unpack_from)
  _tag_unpack_methods[128] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled.unpack_from)
  _tag_unpack_methods[129] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec.unpack_from)
  _tag_unpack_methods[130] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ActivateBehaviorChooser.unpack_from)
  _tag_unpack_methods[131] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType.unpack_from)
  _tag_unpack_methods[132] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteBehaviorByName.unpack_from)
  _tag_unpack_methods[133] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable.unpack_from)
  _tag_unpack_methods[134] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorManagerMessage.unpack_from)
  _tag_unpack_methods[135] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AbortPath.unpack_from)
  _tag_unpack_methods[136] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AbortAll.unpack_from)
  _tag_unpack_methods[137] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StartTestMode.unpack_from)
  _tag_unpack_methods[138] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestEnabledBehaviorList.unpack_from)
  _tag_unpack_methods[139] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestEnableReactionTrigger.unpack_from)
  _tag_unpack_methods[140] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState.unpack_from)
  _tag_unpack_methods[141] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestObjectStates.unpack_from)
  _tag_unpack_methods[142] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DrawPoseMarker.unpack_from)
  _tag_unpack_methods[143] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ErasePoseMarker.unpack_from)
  _tag_unpack_methods[144] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisualizeQuad.unpack_from)
  _tag_unpack_methods[145] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseQuad.unpack_from)
  _tag_unpack_methods[146] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReplayLastAnimation.unpack_from)
  _tag_unpack_methods[147] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetIdleAnimation.unpack_from)
  _tag_unpack_methods[148] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PushIdleAnimation.unpack_from)
  _tag_unpack_methods[149] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PopIdleAnimation.unpack_from)
  _tag_unpack_methods[150] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir.unpack_from)
  _tag_unpack_methods[151] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReadAnimationFile.unpack_from)
  _tag_unpack_methods[152] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestAvailableAnimations.unpack_from)
  _tag_unpack_methods[153] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups.unpack_from)
  _tag_unpack_methods[154] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters.unpack_from)
  _tag_unpack_methods[155] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PushDrivingAnimations.unpack_from)
  _tag_unpack_methods[156] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PopDrivingAnimations.unpack_from)
  _tag_unpack_methods[157] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetHeadlight.unpack_from)
  _tag_unpack_methods[158] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs.unpack_from)
  _tag_unpack_methods[159] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs.unpack_from)
  _tag_unpack_methods[160] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetBackpackLEDs.unpack_from)
  _tag_unpack_methods[161] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableLightStates.unpack_from)
  _tag_unpack_methods[162] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableCubeSleep.unpack_from)
  _tag_unpack_methods[163] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages.unpack_from)
  _tag_unpack_methods[164] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FlashCurrentLightsState.unpack_from)
  _tag_unpack_methods[165] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PlayCubeAnim.unpack_from)
  _tag_unpack_methods[166] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopCubeAnim.unpack_from)
  _tag_unpack_methods[167] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StreamObjectAccel.unpack_from)
  _tag_unpack_methods[168] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState.unpack_from)
  _tag_unpack_methods[169] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoodMessage.unpack_from)
  _tag_unpack_methods[170] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ProgressionMessage.unpack_from)
  _tag_unpack_methods[171] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestSetUnlock.unpack_from)
  _tag_unpack_methods[172] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestDeviceData.unpack_from)
  _tag_unpack_methods[173] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[174] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage.unpack_from)
  _tag_unpack_methods[175] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[176] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[177] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage.unpack_from)
  _tag_unpack_methods[178] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableAllReactionTriggers.unpack_from)
  _tag_unpack_methods[179] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser.unpack_from)
  _tag_unpack_methods[180] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage.unpack_from)
  _tag_unpack_methods[181] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockSelectedMessage.unpack_from)
  _tag_unpack_methods[182] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetBlockPoolMessage.unpack_from)
  _tag_unpack_methods[183] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SendAvailableObjects.unpack_from)
  _tag_unpack_methods[184] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolResetMessage.unpack_from)
  _tag_unpack_methods[185] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveCalibrationImage.unpack_from)
  _tag_unpack_methods[186] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ClearCalibrationImages.unpack_from)
  _tag_unpack_methods[187] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ComputeCameraCalibration.unpack_from)
  _tag_unpack_methods[188] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle.unpack_from)
  _tag_unpack_methods[189] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableDroneMode.unpack_from)
  _tag_unpack_methods[190] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnterSdkMode.unpack_from)
  _tag_unpack_methods[191] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExitSdkMode.unpack_from)
  _tag_unpack_methods[192] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect.unpack_from)
  _tag_unpack_methods[193] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopRobotForSdk.unpack_from)
  _tag_unpack_methods[194] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TransferFile.unpack_from)
  _tag_unpack_methods[195] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageEraseEntry.unpack_from)
  _tag_unpack_methods[196] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWipeAll.unpack_from)
  _tag_unpack_methods[197] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWriteEntry.unpack_from)
  _tag_unpack_methods[198] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry.unpack_from)
  _tag_unpack_methods[199] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageReadEntry.unpack_from)
  _tag_unpack_methods[200] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetCameraSettings.unpack_from)
  _tag_unpack_methods[201] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestRobotSettings.unpack_from)
  ...
  _type_by_tag_value[109] = lambda : Anki.Cozmo.ExternalInterface.ClearAllBlocks
  _type_by_tag_value[110] = lambda : Anki.Cozmo.ExternalInterface.ClearAllObjects
  _type_by_tag_value[111] = lambda : Anki.Cozmo.ExternalInterface.DeleteAllObjects
  _type_by_tag_value[112] = lambda : Anki.Cozmo.ExternalInterface.DeleteAllCustomObjects
  _type_by_tag_value[113] = lambda : Anki.Cozmo.ExternalInterface.CreateFixedCustomObject
  _type_by_tag_value[114] = lambda : Anki.Cozmo.ExternalInterface.DefineCustomBox
  _type_by_tag_value[115] = lambda : Anki.Cozmo.ExternalInterface.DefineCustomCube
  _type_by_tag_value[116] = lambda : Anki.Cozmo.ExternalInterface.DefineCustomWall
  _type_by_tag_value[117] = lambda : Anki.Cozmo.ExternalInterface.SetObjectAdditionAndDeletion
  _type_by_tag_value[118] = lambda : Anki.Cozmo.ExternalInterface.VisionWhileMoving
  _type_by_tag_value[119] = lambda : Anki.Cozmo.ExternalInterface.SetFaceToEnroll
  _type_by_tag_value[120] = lambda : Anki.Cozmo.ExternalInterface.CancelFaceEnrollment
  _type_by_tag_value[121] = lambda : Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID
  _type_by_tag_value[122] = lambda : Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces
  _type_by_tag_value[123] = lambda : Anki.Cozmo.ExternalInterface.EnableVisionMode
  _type_by_tag_value[124] = lambda : Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID
  _type_by_tag_value[125] = lambda : Anki.Cozmo.ExternalInterface.VisionRunMode
  _type_by_tag_value[126] = lambda : Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile
  _type_by_tag_value[127] = lambda : Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile
  _type_by_tag_value[128] = lambda : Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled
  _type_by_tag_value[129] = lambda : Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec
  _type_by_tag_value[130] = lambda : Anki.Cozmo.ExternalInterface.ActivateBehaviorChooser
  _type_by_tag_value[131] = lambda : Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType
  _type_by_tag_value[132] = lambda : Anki.Cozmo.ExternalInterface.ExecuteBehaviorByName
  _type_by_tag_value[133] = lambda : Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable
  _type_by_tag_value[134] = lambda : Anki.Cozmo.ExternalInterface.BehaviorManagerMessage
  _type_by_tag_value[135] = lambda : Anki.Cozmo.ExternalInterface.AbortPath
  _type_by_tag_value[136] = lambda : Anki.Cozmo.ExternalInterface.AbortAll
  _type_by_tag_value[137] = lambda : Anki.Cozmo.ExternalInterface.StartTestMode
  _type_by_tag_value[138] = lambda : Anki.Cozmo.ExternalInterface.RequestEnabledBehaviorList
  _type_by_tag_value[139] = lambda : Anki.Cozmo.ExternalInterface.RequestEnableReactionTrigger
  _type_by_tag_value[140] = lambda : Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState
  _type_by_tag_value[141] = lambda : Anki.Cozmo.ExternalInterface.RequestObjectStates
  _type_by_tag_value[142] = lambda : Anki.Cozmo.ExternalInterface.DrawPoseMarker
  _type_by_tag_value[143] = lambda : Anki.Cozmo.ExternalInterface.ErasePoseMarker
  _type_by_tag_value[144] = lambda : Anki.Cozmo.ExternalInterface.VisualizeQuad
  _type_by_tag_value[145] = lambda : Anki.Cozmo.ExternalInterface.EraseQuad
  _type_by_tag_value[146] = lambda : Anki.Cozmo.ExternalInterface.ReplayLastAnimation
  _type_by_tag_value[147] = lambda : Anki.Cozmo.ExternalInterface.SetIdleAnimation
  _type_by_tag_value[148] = lambda : Anki.Cozmo.ExternalInterface.PushIdleAnimation
  _type_by_tag_value[149] = lambda : Anki.Cozmo.ExternalInterface.PopIdleAnimation
  _type_by_tag_value[150] = lambda : Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir
  _type_by_tag_value[151] = lambda : Anki.Cozmo.ExternalInterface.ReadAnimationFile
  _type_by_tag_value[152] = lambda : Anki.Cozmo.ExternalInterface.RequestAvailableAnimations
  _type_by_tag_value[153] = lambda : Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups
  _type_by_tag_value[154] = lambda : Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters
  _type_by_tag_value[155] = lambda : Anki.Cozmo.ExternalInterface.PushDrivingAnimations
  _type_by_tag_value[156] = lambda : Anki.Cozmo.ExternalInterface.PopDrivingAnimations
  _type_by_tag_value[157] = lambda : Anki.Cozmo.ExternalInterface.SetHeadlight
  _type_by_tag_value[158] = lambda : Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs
  _type_by_tag_value[159] = lambda : Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs
  _type_by_tag_value[160] = lambda : Anki.Cozmo.ExternalInterface.SetBackpackLEDs
  _type_by_tag_value[161] = lambda : Anki.Cozmo.ExternalInterface.EnableLightStates
  _type_by_tag_value[162] = lambda : Anki.Cozmo.ExternalInterface.EnableCubeSleep
  _type_by_tag_value[163] = lambda : Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages
  _type_by_tag_value[164] = lambda : Anki.Cozmo.ExternalInterface.FlashCurrentLightsState
  _type_by_tag_value[165] = lambda : Anki.Cozmo.ExternalInterface.PlayCubeAnim
  _type_by_tag_value[166] = lambda : Anki.Cozmo.ExternalInterface.StopCubeAnim
  _type_by_tag_value[167] = lambda : Anki.Cozmo.ExternalInterface.StreamObjectAccel
  _type_by_tag_value[168] = lambda : Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState
  _type_by_tag_value[169] = lambda : Anki.Cozmo.ExternalInterface.MoodMessage
  _type_by_tag_value[170] = lambda : Anki.Cozmo.ExternalInterface.ProgressionMessage
  _type_by_tag_value[171] = lambda : Anki.Cozmo.ExternalInterface.RequestSetUnlock
  _type_by_tag_value[172] = lambda : Anki.Cozmo.ExternalInterface.RequestDeviceData
  _type_by_tag_value[173] = lambda : Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage
  _type_by_tag_value[174] = lambda : Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage
  _type_by_tag_value[175] = lambda : Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage
  _type_by_tag_value[176] = lambda : Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage
  _type_by_tag_value[177] = lambda : Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage
  _type_by_tag_value[178] = lambda : Anki.Cozmo.ExternalInterface.EnableAllReactionTriggers
  _type_by_tag_value[179] = lambda : Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser
  _type_by_tag_value[180] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
  _type_by_tag_value[181] = lambda : Anki.Cozmo.ExternalInterface.BlockSelectedMessage
  _type_by_tag_value[182] = lambda : Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
  _type_by_tag_value[183] = lambda : Anki.Cozmo.ExternalInterface.SendAvailableObjects
  _type_by_tag_value[184] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
  _type_by_tag_value[185] = lambda : Anki.Cozmo.ExternalInterface.SaveCalibrationImage
  _type_by_tag_value[186] = lambda : Anki.Cozmo.ExternalInterface.ClearCalibrationImages
  _type_by_tag_value[187] = lambda : Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
  _type_by_tag_value[188] = lambda : Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
  _type_by_tag_value[189] = lambda : Anki.Cozmo.ExternalInterface.EnableDroneMode
  _type_by_tag_value[190] = lambda : Anki.Cozmo.ExternalInterface.EnterSdkMode
  _type_by_tag_value[191] = lambda : Anki.Cozmo.ExternalInterface.ExitSdkMode
  _type_by_tag_value[192] = lambda : Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
  _type_by_tag_value[193] = lambda : Anki.Cozmo.ExternalInterface.StopRobotForSdk
  _type_by_tag_value[194] = lambda : Anki.Cozmo.ExternalInterface.TransferFile
  _type_by_tag_value[195] = lambda : Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
  _type_by_tag_value[196] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWipeAll
  _type_by_tag_value[197] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
  _type_by_tag_value[198] = lambda : Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
  _type_by_tag_value[199] = lambda : Anki.Cozmo.ExternalInterface.NVStorageReadEntry
  _type_by_tag_value[200] = lambda : Anki.Cozmo.ExternalInterface.SetCameraSettings
  _type_by_tag_value[201] = lambda : Anki.Cozmo.ExternalInterface.RequestRobotSettings
