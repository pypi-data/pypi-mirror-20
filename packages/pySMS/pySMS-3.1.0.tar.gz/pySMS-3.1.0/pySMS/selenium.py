...
class macros():
    ...
    def mutate(self, _dict):
        ...
        try:
            ...
            print(Fore.LIGHTRED_EX + 'Failed to parse table. Item [{}]'.format(_dict['productNumber']))
            self.err.err_basic('Failed to parse table for [{}], please mutate and hit enter to continue'.format(_dict['productNumber']), 'Mutation Error')
