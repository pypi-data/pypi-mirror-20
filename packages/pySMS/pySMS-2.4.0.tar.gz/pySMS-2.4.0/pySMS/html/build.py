...
class buildPaths():
    ...
    class buildUserPage(buildMainPaths):
        ...
        def uUser(self):
            path = "body > div:nth-child(8) > div:nth-child(2) > div > div:nth-child(3) > div > div:nth-child(2) > div > div > div > table > tbody > tr > td.GLNOMTPDLX > table > tbody > tr > td"
...
# b = buildPaths()
# bl = b.buildLoginPaths()
# print(bl.bLoginFailed())