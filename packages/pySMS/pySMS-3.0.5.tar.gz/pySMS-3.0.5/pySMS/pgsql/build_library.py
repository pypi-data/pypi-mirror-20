...
class structData():
    ...
    def build_library(self): #build collection of product type specific dictionaries
        ...
        for key, val in dict.items():
            ...
            for item in val:
                print(Fore.LIGHTCYAN_EX + 'With book ' + key + Fore.LIGHTYELLOW_EX +
                      Fore.LIGHTYELLOW_EX + ' Writing page #' + str(num) + ': ' + Fore.CYAN + str(item[_ids['product_number']]) +
        ...
        print(Fore.LIGHTGREEN_EX + 'Library Complete. ' + Fore.LIGHTCYAN_EX + str(num) + Fore.LIGHTYELLOW_EX + " items written.")
