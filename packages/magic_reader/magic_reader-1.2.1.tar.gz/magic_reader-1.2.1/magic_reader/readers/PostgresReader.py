...
class PostgresReader(object):
    ...
    def __init__(self, source_path, real_path=None):
        ...
        self.connection_args.setdefault("database", args.get("db"))
    ...
    def read(self):
        ...
        cursor = self.connection.cursor(psycopg2.extras.RealDictCursor) if self.return_results_as else self.connection.cursor()
