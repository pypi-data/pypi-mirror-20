...
def create_pairwise_multiple(candidate_id, 
	...
	from association_measures.calculate_reduced_beginning_lr import calculate_reduced_beginning_lr
	from association_measures.calculate_reduced_beginning_rl import calculate_reduced_beginning_rl
	
	from association_measures.calculate_reduced_end_lr import calculate_reduced_end_lr
	from association_measures.calculate_reduced_end_rl import calculate_reduced_end_rl
	
	from association_measures.calculate_directional_scalar import calculate_directional_scalar
	from association_measures.calculate_directional_categorical import calculate_directional_categorical
	
	from association_measures.calculate_endpoint import calculate_endpoint
