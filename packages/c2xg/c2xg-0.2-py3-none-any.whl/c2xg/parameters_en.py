...
def set_parameters(C2xG_Parameters):
	...
	#General settings#
	C2xG_Parameters.Nickname = "English"				#Name this series of experiments and the produced models
	...
	C2xG_Parameters.Illegal_POS = ["X", "."]					#Items with these pos-tags will be ignored; for most languages we use the Universal POS-Tags and this ignores punctuation and misc
	...
	C2xG_Parameters.Freq_Threshold_Individual = 1000			#Individual units (words, pos-tags, semantic categories) below this threshold will be assigned to 0 index
	C2xG_Parameters.Freq_Threshold_Idioms = 100					#Frequency threshold for candidates total
	C2xG_Parameters.Freq_Threshold_Idioms_Perfile = 5			#Frequency threshold for candidates within each file
	C2xG_Parameters.Freq_Threshold_Constituents = 1000			#Frequency threshold for candidates total
	C2xG_Parameters.Freq_Threshold_Constituents_Perfile = 5		#Frequency threshold for candidates within each file
	C2xG_Parameters.Freq_Threshold_Constructions = 1000			#Frequency threshold for candidates total
	C2xG_Parameters.Freq_Threshold_Constructions_Perfile = 5	#Frequency threshold for candidates within each file
	...
	C2xG_Parameters.Max_Candidate_Length_Constituents = 6
	...
	C2xG_Parameters.Tabu_Direct_Move_Number = 100				#Number of moves to check per feature for each turn of the Tabu Search (for 30*n moves each turn)#
	C2xG_Parameters.Tabu_Direct_Move_Size = 30					#Maximum number of parameters that can be changed in a single move of the Tabu Search (out of 30 possible parameters)#
	C2xG_Parameters.Tabu_Indirect_Move_Number = 500				#Number of moves to check for direct search#
	C2xG_Parameters.Tabu_Indirect_Move_Size = 250				#Maximum number of parameters that can be changed in a single move of the indirect Tabu Search (in candidates)#
	...
	C2xG_Parameters.Run_Tagger = False							#True: input raw tex, one document per line; False: input CoNLL formatted texts
	...
	C2xG_Parameters.CV = 5										#Number of folds for cross-fold validation for each iteration
	...
	C2xG_Parameters.Training_Search = 25000						#Number of documents / sentences (ids) to use for training files during restarts
	C2xG_Parameters.Testing = 50000								#Number of documents / sentences (ids) to use for testing files, once per fold
