...
def set_parameters(C2xG_Parameters):
	...
	#General settings#
	C2xG_Parameters.Nickname = "Spanish.MDL.3-8"				#Name this series of experiments and the produced models
	C2xG_Parameters.Language = "Spanish"						#Language is used to select the correct RDRPOSTagger model; thus, must have the same name as an available model
	...
	C2xG_Parameters.Dictionary_File = "Spanish.Aranea.DIM=500.SG=1.HS=1.ITER=25.txt"
