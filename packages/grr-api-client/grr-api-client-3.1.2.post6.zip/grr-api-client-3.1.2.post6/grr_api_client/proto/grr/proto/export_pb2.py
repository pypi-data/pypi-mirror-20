...
_EXPORTEDMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='hardware_info', full_name='ExportedMetadata.hardware_info', index=15,
