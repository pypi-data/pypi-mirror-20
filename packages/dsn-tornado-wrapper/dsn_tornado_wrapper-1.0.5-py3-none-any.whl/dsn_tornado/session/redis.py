...
class RedisSession(Session):
    ...
    def contains_key(self, key: str) -> bool:
        return self._hashmap.contains_key(key)
    ...
    def get_integer(self, key: str, base: int = 10):
        return self._hashmap.get_integer(key, base)

    def get_string(self, key: str, encoding='UTF-8'):
        return self._hashmap.get_string(key, encoding)
