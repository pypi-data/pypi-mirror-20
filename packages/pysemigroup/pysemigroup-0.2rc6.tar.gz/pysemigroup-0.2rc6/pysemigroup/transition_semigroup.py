...
from .utils import view_graphviz, file_graphviz
...
class TransitionSemiGroup:
    ...
    def box_to_file(self,filename):
        file_graphviz(self.graphviz_string(),filename)
    def view(self, save_to_file=None,arrow=True,verbose=False,unfold=True):
        view_graphviz(self.graphviz_string(arrow=arrow,verbose=verbose,unfold=unfold),save_to_file=save_to_file)

    def view_cayley(self,orientation="left_right",save_to_file=None):
        view_graphviz(self.cayley_graphviz_string(orientation=orientation),save_to_file=save_to_file)        
    def cayley_to_file(self,filename,orientation="left_right"):
        file_graphviz(self.cayley_graphviz_string(orientation=orientation),filename)
