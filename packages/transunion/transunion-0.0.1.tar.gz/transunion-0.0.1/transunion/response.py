from errors import TransUnionAPIError, IllFormattedResponse
from transunion.utils.xml_convert import dumps
...
def raise_for_api_errors(data):
    try:
        ...
        raise IllFormattedResponse(data=data)
    else:
...
def get_report(data):
    return data['pfs']['product']['subject']['subjectRecord']
