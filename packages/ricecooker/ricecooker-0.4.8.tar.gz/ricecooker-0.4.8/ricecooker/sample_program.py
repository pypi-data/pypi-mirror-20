...
from ricecooker.exceptions import UnknownContentKindError, UnknownFileTypeError, UnknownQuestionTypeError, raise_for_invalid_channel, InvalidFormatException
...
SAMPLE_TREE = [
    ...
    #             "files": [
    #                 {
    #                     "path": "https://ia600209.us.archive.org/27/items/RiceChef/Rice Chefs",
    #                 },
    #                 {
    ...
    #     "children": [
            ...
            # },
            {
                ...
                "questions": [
                    ...
                    {
                        "id": "bbbbb",
                        "question": "Which rice is the crunchiest?![](https://upload.wikimedia.org/wikipedia/commons/c/cd/RKTsquares.jpg)",
