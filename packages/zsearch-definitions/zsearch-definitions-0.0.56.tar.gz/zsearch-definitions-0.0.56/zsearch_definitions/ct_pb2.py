...
# source: zsearch_definitions/ct.proto
...
CTServerStatus = _reflection.GeneratedProtocolMessageType('CTServerStatus', (_message.Message,), dict(
  ...
  __module__ = 'zsearch_definitions.ct_pb2'
