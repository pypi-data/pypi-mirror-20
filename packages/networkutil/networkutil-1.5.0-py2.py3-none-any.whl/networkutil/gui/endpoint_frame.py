...
from ..endpoint_config import ENDPOINTS_CONFIG, Endpoints, EnvAndAPIs
...
class EndpointsFrame(DynamicFrame):
    ...
    def update_env(self,
        ...
        self.item_dict[self.endpoints.EP_ENV] = env
    ...
    def update_apis(self,
        ...
        self.item_dict[self.endpoints.EP_APIS] = apis
    ...
    def api_select_trace(self,
        ...
        current_apis = self.item_dict.get(self.endpoints.EP_APIS, [])
        ...
        self.item_dict[self.endpoints.EP_APIS] = current_apis
    ...
    def _add_edit(self,
        ...
        if edit:
            ...
            env = self.item_dict.get(self.endpoints.EP_ENV)
    ...
    def delete(self):
        ...
        if len(self.cfg[ENDPOINTS_CONFIG]) <= 1:
            tkMessageBox.showerror(u'Delete Endpoint',
                                   u'Cannot remove last endpoint!',
                                   parent=self)

        else:
            result = tkMessageBox.askquestion(u"Delete Endpoint",
