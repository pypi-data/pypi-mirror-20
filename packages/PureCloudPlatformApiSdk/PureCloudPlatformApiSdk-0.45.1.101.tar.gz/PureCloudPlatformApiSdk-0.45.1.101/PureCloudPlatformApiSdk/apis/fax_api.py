...
class FaxApi(object):
    ...
    def put_documents_document_id(self, document_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.put_documents_document_id(document_id, body, callback=callback_function)
        ...
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `put_documents_document_id`")
