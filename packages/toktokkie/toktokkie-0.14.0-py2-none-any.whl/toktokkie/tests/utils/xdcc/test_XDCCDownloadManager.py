...
class UnitTests(unittest.TestCase):
    ...
    def test_download_preparer(self):
        ...
        destination_dir, season_dir = XDCCDownloadManager.prepare_directory(self.game_of_thrones, u"Game of Thrones", 1)
        self.assertEqual(destination_dir, self.game_of_thrones)
        self.assertEqual(season_dir, os.path.join(self.game_of_thrones, u"Season 1"))
        self.assertTrue(MetaDataManager.is_media_directory(self.game_of_thrones, u"tv_series"))

    def test_download_preparer_with_non_matching_show_name(self):

        self.assertFalse(MetaDataManager.is_media_directory(os.path.join(self.game_of_thrones, u"Not Game of Thrones")))
        destination_dir, season_dir = XDCCDownloadManager.prepare_directory(
            self.game_of_thrones, u"Not Game of Thrones", 1)

        self.assertEqual(destination_dir, os.path.join(self.game_of_thrones, u"Not Game of Thrones"))
        self.assertEqual(season_dir, os.path.join(destination_dir, u"Season 1"))
        self.assertTrue(MetaDataManager.is_media_directory(destination_dir, u"tv_series"))
    ...
    def test_auto_renaming(self):
        ...
        self.assertTrue(os.path.isfile(os.path.join(self.game_of_thrones, u"Season 1",
    ...
    def test_preliminary_auto_renaming_results(self):
        ...
        results = XDCCDownloadManager.get_preliminary_renaming_results(PlexTvdbScheme, 1, packs, 1, u"Game of Thrones")

        self.assertEqual(results[0], u"Game of Thrones - S01E01 - Winter Is Coming")
        self.assertEqual(results[1], u"Game of Thrones - S01E02 - The Kingsroad")
        self.assertEqual(results[2], u"Game of Thrones - S01E03 - Lord Snow")
