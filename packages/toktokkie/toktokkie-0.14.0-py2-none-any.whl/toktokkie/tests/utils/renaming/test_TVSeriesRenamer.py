...
class TVSeriesRenamerUnitTests(unittest.TestCase):
    ...
    def test_unconfirmed_renaming(self):
        renamer = TVSeriesRenamer(os.path.join(u"temp_testing", u"Game of Thrones"), PlexTvdbScheme)
        confirmation = renamer.request_confirmation()
        renamer.confirm(confirmation)
        renamer.start_rename()

        self.assertTrue(os.path.isfile(os.path.join(u"temp_testing", u"Game of Thrones", u"Season 1", u"Episode 01.mkv")))
        self.assertFalse(os.path.isfile(os.path.join(u"temp_testing", u"Game of Thrones", u"Season 1",
