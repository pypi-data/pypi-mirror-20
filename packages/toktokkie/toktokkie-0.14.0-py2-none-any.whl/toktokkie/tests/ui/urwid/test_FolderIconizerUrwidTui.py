...
class UnitTests(unittest.TestCase):
    ...
    def test_non_recursive_iconizing(self):
        ...
        self.tui.directory_edit.set_edit_text(os.path.join(u"temp_testing", u"Game of Thrones"))
        ...
        if procedure != GenericProcedure:
            ...
            self.assertEqual(
                os.path.abspath(
                    procedure.get_icon_file(os.path.join(u"temp_testing", u"Game of Thrones"))),
                os.path.abspath(
                    os.path.join(u"temp_testing", u"Game of Thrones", u".meta", u"icons", u"main" + icon_ext)))

            self.assertEqual(
                os.path.abspath(
                    procedure.get_icon_file(os.path.join(u"temp_testing", u"Game of Thrones", u"Season 1"))),
                os.path.abspath(
                    os.path.join(u"temp_testing", u"Game of Thrones", u".meta", u"icons", u"Season 1" + icon_ext)))

            self.assertEqual(procedure.get_icon_file(os.path.join(u"temp_testing", u"The Big Bang Theory")), None)
    ...
    def test_recursive_iconizing(self):
        ...
        if procedure != GenericProcedure:
            ...
            self.assertEqual(
                os.path.abspath(
                    procedure.get_icon_file(os.path.join(u"temp_testing", u"The Big Bang Theory"))),
                os.path.abspath(
                    os.path.join(u"temp_testing", u"The Big Bang Theory", u".meta", u"icons", u"main" + icon_ext)))
    ...
    def test_spinner(self):
        ...
        self.assertTrue(self.tui.iconize_button.get_label().startswith(u"Iconizing"))
