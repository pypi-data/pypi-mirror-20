...
class UnitTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        shutil.copytree(os.path.join(u"toktokkie", u"tests", u"resources", u"json"), u"json_test")
    ...
    def test_adding_new_series(self):
        ...
        self.assertTrue(self.form.json_handler.get_series()[0].equals(
            Series(os.getcwdu(), u"New Series", u"1080p", u"Bot", 1, [u"nibl"], u"Plex (TVDB)", u"horriblesubs")
        ))
    ...
    def test_saving_new_json_file(self):
        ...
        self.assertEqual(self.form.json_handler.get_json_file_path(), u"a_json_file.json")
        self.assertEqual(len(JsonHandler(u"a_json_file.json").get_series()), len(self.form.json_handler.get_series()))
    ...
    def test_saving_to_previous_file(self):
        ...
        self.assertTrue(os.path.isfile(os.path.join(u"json_test", u"updater.json")))
    ...
    def test_changing_series_info(self):
        ...
        self.assertEqual(u"Not Drifters", self.form.json_handler.get_series()[1].get_search_name())
