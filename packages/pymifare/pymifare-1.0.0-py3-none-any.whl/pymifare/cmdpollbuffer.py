...
class CmdPollBuffer(CommandBaseSpv1):
    def __init__(self):
        super().__init__(spv1handler, spv1handler.dll.spv1_create_cmdpollbuffer)

        # dll functions
        self.spv1_command_build_api = spv1handler.dll.spv1_build_cmdpollbuffer
        self.spv1_command_build_api.restype = STRUCT_SPV1FRAME
        self.spv1_command_build_api.argtypes = (ctypes.c_ulong,ctypes.c_ubyte)

        self.spv1_get_response_api = spv1handler.dll.spv1_get_response_cmdpollbuffer
