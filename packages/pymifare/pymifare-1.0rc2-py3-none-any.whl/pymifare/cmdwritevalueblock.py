...
class CmdWriteValueBlock(CommandBaseSpv1):

    def __init__(self):
        super().__init__(spv1handler, spv1handler.dll.spv1_create_cmdwritevalueblock)

        self.spv1_command_build_api = spv1handler.dll.spv1_build_cmdwritevalueblock
        self.spv1_command_build_api.restype = STRUCT_SPV1FRAME
        self.spv1_command_build_api.argtypes = (ctypes.c_ulong, CmdWriteValueBlock.PARAMS_WRITE_VALUE_BLOCK)

        self.spv1_get_response_api = spv1handler.dll.spv1_get_response_cmdwritevalueblock
    ...
    class PARAMS_WRITE_VALUE_BLOCK(PARAMS_WRITE_VALUE_BLOCK_BASE):
        def __init__(self):
            super().__init__()
