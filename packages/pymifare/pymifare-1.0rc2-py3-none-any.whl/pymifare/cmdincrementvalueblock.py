...
class CmdIncrementValueBlock(CommandBaseSpv1):

    def __init__(self):
        super().__init__(spv1handler, spv1handler.dll.spv1_create_cmdincrementvalueblock)

        self.spv1_command_build_api = spv1handler.dll.spv1_build_cmdincrementvalueblock
        self.spv1_command_build_api.restype = STRUCT_SPV1FRAME
        self.spv1_command_build_api.argtypes = (ctypes.c_ulong, CmdIncrementValueBlock.PARAMS_INCREMENT_VALUE_BLOCK)

        self.spv1_get_response_api = spv1handler.dll.spv1_get_response_cmdincrementvalueblock
    ...
    class PARAMS_INCREMENT_VALUE_BLOCK(PARAMS_WRITE_VALUE_BLOCK_BASE):
        def __init__(self):
            super().__init__()
