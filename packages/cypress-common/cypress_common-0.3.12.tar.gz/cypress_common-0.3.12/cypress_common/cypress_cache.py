...
class CypressCache(CypressBase):
    ...
    #     :return:
    #     """
    #     if isinstance(metadata, str) and len(metadata) > max_size:
    ...
    #     self.add_to_sorted_set(set_name, set_value, random_score)
    #
    ...
    def add_to_failed_images(self, task_id, image_id, err_code):
        ...
        """
        if err_code not in DATA_IMPORT_FAIL_TYPES.keys():
    ...
    def delete_failed_images(self, task_id):
        ...
        """
        task_id = str(task_id)
        for err_code in DATA_IMPORT_FAIL_TYPES.keys():
