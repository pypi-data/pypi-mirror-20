...
init_path = os.path.join('kore_plugins_celery', '__init__.py')
...
entry_points = """\
[kore.components]
kore.components.celery =\
    kore_plugins_celery.plugins.celery:CeleryPluginComponent
"""


setup(
    name='kore-plugins-celery',
    version=metadata['version'],
    author=metadata['author'],
    author_email=metadata['email'],
    url=metadata['url'],
    packages=find_packages(include=('kore_plugins_celery*',)),
