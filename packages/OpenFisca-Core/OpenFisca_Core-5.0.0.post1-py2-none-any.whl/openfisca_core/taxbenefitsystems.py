...
class TaxBenefitSystem(object):
    ...
    def add_variable(self, variable):
        ...
        :param variable: The variable to add. Must be a sublcass of Variable or DatedVariable.
    ...
    def update_variable(self, variable):
        ...
        :param variable: Variable to add. Must be a sublcass of Variable or DatedVariable.
        """
