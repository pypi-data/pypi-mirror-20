...
class CourseJournalPdfView(CourseJournalView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        response['Content-Disposition'] = 'attachment; filename="{}.pdf"'.format(slugify(course))

        # create basic pdf registration from rml template
        return course.write_journal_pdf(response)
