...
File version 0.2 date 2017-03-06
...
class SteelSection(MaterialSteel):
    ...
    @property
    def f_u(self):
        thickness = self._f_thickness()
        value = MaterialSteel.f_u(self, thickness)
        return value
    ...
    @property
    def M_zcRd(self):
        return self.__sectionresistance.M_cRd(self.W_ply, self.W_elz, self.f_y, self.class_bend_z)
    @property
    def V_ycRd(self):
