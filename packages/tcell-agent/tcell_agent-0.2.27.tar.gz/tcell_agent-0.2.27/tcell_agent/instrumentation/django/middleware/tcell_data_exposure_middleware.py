...
class TCellDataExposureMiddleware(object):
    ...
    def process_request(self, request):
        safe_wrap_function("Data-Exposure for Request Forms", form_dataex, request)
        safe_wrap_function("Data-Exposure for Request Cookies", cookie_dataex, request)
        safe_wrap_function("Data-Exposure for Request Headers", header_dataex, request)
