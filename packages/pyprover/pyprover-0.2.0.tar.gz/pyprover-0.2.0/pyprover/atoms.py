...
class LowercasePropositions(Vars):  # line 47
    a, b, c = propositions("a b c")  # line 48
    d, e, f = propositions("d e f")  # line 49
    g, h, i = propositions("g h i")  # line 50
    j, k, l = propositions("j k l")  # line 51
    m, n, o = propositions("m n o")  # line 52
    p, q, r = propositions("p q r")  # line 53
    s, t, u = propositions("s t u")  # line 54
    v, w, x = propositions("v w x")  # line 55
    y, z = propositions("y z")  # line 56

class UppercasePropositions(Vars):  # line 58
    A, B, C = propositions("A B C")  # line 59
    D, E, F = propositions("D E F")  # line 60
    G, H, I = propositions("G H I")  # line 61
    J, K, L = propositions("J K L")  # line 62
    M, N, O = propositions("M N O")  # line 63
    P, Q, R = propositions("P Q R")  # line 64
    S, T, U = propositions("S T U")  # line 65
    V, W, X = propositions("V W X")  # line 66
    Y, Z = propositions("Y Z")  # line 67
