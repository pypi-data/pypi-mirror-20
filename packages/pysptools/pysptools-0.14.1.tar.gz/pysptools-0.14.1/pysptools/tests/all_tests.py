...
from pysptools.tests import test_cls, test_detect, test_dnoise, test_vd, test_hull, \
     test_pwc, test_spectro, test_eea, test_HyperSVC, test_sklearn, \
     test_sklearn_multi_labels
...
def all_tests():
    ...
    try:
        print('====> testing test_sklearn')
        test_sklearn.tests()
    except Exception:
        print('************ Error in test: test_sklearn')
    try:
        print('====> testing test_sklearn_multi_labels')
        test_sklearn_multi_labels.tests()
    except Exception:
        print('************ Error in test: test_sklearn_multi_labels')
