...
from pysptools.sklearn import (HyperEstimatorCrossVal, HyperSVC, HyperLogisticRegression,
                               HyperRandomForestClassifier, HyperKNeighborsClassifier)
from test_sklearn_util import HyperEstimatorTraining, DataMine, Mask, remove_bands
...
def test_HyperEstimatorCrossVal(M, mask):
    ...
    ecv = HyperEstimatorCrossVal(HyperLogisticRegression, 'RB', p_grid)
    ecv.fit_cube(M, mask)
    ecv.print()
    return ecv
