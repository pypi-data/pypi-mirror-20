...
from pysptools.classification import out
...
class SVC(object):
    ...
    The ROIs classifiers can be raw binary, rectangles or polygons. They must be
    VALID, no check is made upon the validity of these geometric figures.
    """
    ...
    def fit(self, M, ROIs, C=1.0, class_weight=None, cache_size=200, coef0=0.0, degree=3,
        ...
        self.clf = svm.SVC(C=C, class_weight=class_weight, cache_size=cache_size,
