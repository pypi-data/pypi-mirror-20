...
from congo.getpaid import signals
from congo.getpaid.backends import PaymentProcessorBase
from congo.getpaid.backends.payu.tasks import get_payment_status_task, accept_payment
...
class PaymentProcessor(PaymentProcessorBase):
    ...
    def online(pos_id, session_id, ts, sig):
        ...
        get_payment_status_task(payment_id, session_id)
        return u'OK'
