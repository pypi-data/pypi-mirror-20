# getpaid views
from congo.getpaid.forms import PaymentMethodForm, ValidationError
from congo.getpaid.signals import redirecting_to_payment_gateway_signal, order_additional_validation
...
class NewPaymentView(FormView):
    ...
    def form_valid(self, form):
        ...
        try:
            order_additional_validation.send(sender = None, request = self.request, order = form.cleaned_data['order'], backend = form.cleaned_data['backend'])
