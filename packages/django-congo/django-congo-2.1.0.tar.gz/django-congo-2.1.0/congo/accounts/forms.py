...
#        add_widget_css_class(self, 'form-control')
    ...
    def clean(self):
        ...
        if email1 and email2 and email1 != email2:
            self.add_error('email2', _(u"Wprowadzone adresy e-mail nie pasują."))
    ...
    def save(self):
        ...
        user = get_user_model().objects.create_user(DjUserManager.normalize_email(data['email1']), data['password1'])
