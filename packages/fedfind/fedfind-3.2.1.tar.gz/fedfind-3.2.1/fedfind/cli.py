...
def parse_args():
    ...
    parser_images.add_argument(
        ...
        "nightly Atomic composes. 'Branched' and 'Rawhide' are the two "
        "mainline nightly compose types, see the wiki for more details. "
        "'Production' is for candidate composes on the compose server "
        "(kojipkgs) and identified by a date and respin, as opposed to the "
        "same composes synced to alt and identified by label. Respin is "
        "for the semi-official post-release live respin composes.",
        choices=['Alpha', 'Beta', 'Final', 'RC', 'Atomic', 'Branched',
                 'Rawhide', 'Production', 'Respin'])
    parser_images.add_argument(
