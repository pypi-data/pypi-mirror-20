...
class TestRelease:
    ...
    def test_get_release_cid_atomic(self):
        """Test that 2 Week Atomic 'compose IDs' are handled. openQA
        uses the directory name as the 'compose ID', it looks like
        23-20160427 or 23-20160427.1 for a respin.
        """
