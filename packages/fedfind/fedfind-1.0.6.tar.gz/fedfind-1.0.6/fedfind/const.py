...
FILESYSTEM_EXTS = ('.tar.gz',)
ISO_EXTS = ('.iso',)
IMAGE_EXTS = DISK_EXTS + FILESYSTEM_EXTS + ISO_EXTS
ISO_TYPES = ('dvd', 'live', 'netinst', 'disc1', 'disc2', 'disc3', 'disc4',
             'disc5', 'disc6', 'rescuecd')
...
LOADOUTS = (
    ...
    LoadTuple('soas', ('soas',), (), 72),
    LoadTuple('mate', ('mate_compiz', 'mate-compiz', 'mate'), (), 71),
