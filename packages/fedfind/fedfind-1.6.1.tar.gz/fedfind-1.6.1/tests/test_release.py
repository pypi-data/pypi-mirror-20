...
class TestRelease:
    ...
    def test_get_release_offline(self):
        ...
        rels = (
            ...
            # Branched nightly (date obj).
            ((23, 'Branched', dateobj), (fedfind.release.BranchedNightly, '23', 'Branched', datestr)),
            # Rawhide nightly.
            (('Rawhide', '', dateobj), (fedfind.release.RawhideNightly, 'Rawhide', '', datestr)),
            # Wikitcms format Rawhide.
            (('24', 'Rawhide', dateobj), (fedfind.release.RawhideNightly, 'Rawhide', '', datestr)),
            # OFFLINE GUESSES
            # Date guesses.
        ...
        for ((release, milestone, compose), expected) in rels:
            got = fedfind.release.get_release(release, milestone, compose)
    ...
    def test_get_release_online(self):
        ...
        got = fedfind.release.get_release('22')
