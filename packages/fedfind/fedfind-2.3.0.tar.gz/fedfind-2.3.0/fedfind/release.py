...
class Release(object):
    ...
    def difference(self, other):
        ...
        for other. Returns a set of (subvariant, imagetype, arch)
        tuples identifying the unique images. 'other' must be another
        Release instance (you may often want to use
        self.previous_release).
        """
        ours = set(
            (img['subvariant'], img['type'], img['arch'])
