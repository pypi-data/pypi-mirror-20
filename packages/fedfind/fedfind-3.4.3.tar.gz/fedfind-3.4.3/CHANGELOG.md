...
*   [fedfind-3.4.3.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.4.3.tar.xz)

1.  Fix tests for `disc_number` change from 3.4.2

### 3.4.2 - 2017-02-10

*   [fedfind-3.4.2.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.4.2.tar.xz)

1.  Include `disc_number` in synthesized image dicts

### 3.4.1 - 2017-02-10

*   [fedfind-3.4.1.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.4.1.tar.xz)
...
*   [fedfind-3.4.0.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.4.0.tar.xz)
...
*   [fedfind-3.3.0.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.3.0.tar.xz)
...
*   [fedfind-3.2.5.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.2.5.tar.xz)

1.  Add missing changelog entry for 3.2.4 (forgot to update it in 3.2.4 release)

### 3.2.4 - 2017-01-13

*   [fedfind-3.2.4.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.2.4.tar.xz)
...
*   [fedfind-3.2.3.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.2.3.tar.xz)

1.  Fix tests for a change from 3.2.1

### 3.2.2 - 2016-12-14

*   [fedfind-3.2.2.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.2.2.tar.xz)

1.  Get rid of an `image.py` which snuck into the 3.2.1 release and kinda broke it

### 3.2.1 - 2016-12-08

*   [fedfind-3.2.1.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.2.1.tar.xz)
...
*   [fedfind-3.2.0.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.2.0.tar.xz)
...
*   [fedfind-3.1.3.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.1.3.tar.xz)

1.  Fix some release number check problems (inc. `get_package_nvras` crashing for Rawhide)

### 3.1.2 - 2016-11-30

*   [fedfind-3.1.2.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.1.2.tar.xz)

1.  Improve caching implementation to work (in degraded mode) if user home dir is not writable

### 3.1.1 - 2016-11-29

*   [fedfind-3.1.1.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.1.1.tar.xz)
...
*   [fedfind-3.1.0.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.1.0.tar.xz)
...
*   [fedfind-3.0.4.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.0.4.tar.xz)
...
*   [fedfind-3.0.3.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.0.3.tar.xz)

1.  Tests don't hard require caplog any more

### 3.0.2 - 2016-11-23

*   [fedfind-3.0.2.tar.xz](https://www.happyassassin.net/fedfind/releases/fedfind-3.0.2.tar.xz)
