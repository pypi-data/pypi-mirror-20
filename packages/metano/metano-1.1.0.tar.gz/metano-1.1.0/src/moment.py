...
@author: Julia Helmecke
@email: julia.helmecke@tu-bs.de
"""
...
""" VERSION HISTORY
    alpha_1.0   basic MOMENT algorithm
    alpha_1.1   added classes and command line tool
    alpha_1.2   added json config file with parser, some small enhancements
    alpha_1.3   added the automatical identification of reaction candidates
    #alpha_1.4   added the possibility to take more than one reaction to the next iteration
"""
