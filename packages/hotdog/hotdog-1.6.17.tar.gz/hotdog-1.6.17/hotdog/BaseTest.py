        ...
        if not hasattr(builtins, 'threadlocal'):
            ...
            try:
                if 'grid' in provider:
                    ...
                    if builtins.threadlocal.config['desiredCaps']['browserName'].lower() == 'firefox':
                        browser_profile = seleniumWebdriver.FirefoxProfile()
                        browser_profile.set_preference('layers.acceleration.disabled', True)
