...
class MultiBeatJSONDecoder(json.JSONDecoder):
    def __init__(self, *args, **kargs):
        super(MultiBeatJSONDecoder, self).__init__(object_hook=self.dict_to_object, *args, **kargs)
...
class MultiBeatJSONEncoder(json.JSONEncoder):
    def default(self, obj):
        ...
        return super(MultiBeatJSONEncoder, self).default(obj)
