...
_cffi_f_XSetErrorHandler(PyObject *self, PyObject *arg0)
{
  ...
  x0 = (int(*)(Display *, XErrorEvent *))_cffi_to_c_pointer(arg0, _cffi_type(11));
...
PyMODINIT_FUNC
PyInit__cffi__x26cf2f06x3c566d49(void)
{
  PyObject *lib;
...
PyMODINIT_FUNC
init_cffi__x26cf2f06x3c566d49(void)
{
  PyObject *lib;
  lib = Py_InitModule("_cffi__x26cf2f06x3c566d49", _cffi_methods);
  if (lib == NULL)
    return;
  if (((void)lib,0) < 0 || _cffi_init() < 0)
    return;
