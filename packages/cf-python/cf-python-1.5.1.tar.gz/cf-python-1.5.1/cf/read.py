...
#        promote = set(('field', 'coordinate', 'measure'))
    ...
    if umversion is not None:
        raise ValueError("The umversion parameter has been deprecated. Use the um parameter instead")    
