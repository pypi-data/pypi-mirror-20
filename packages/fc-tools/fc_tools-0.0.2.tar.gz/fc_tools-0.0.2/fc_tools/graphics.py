...
#def set_axes_equal_test(**kwargs):
  ## Taken from http://stackoverflow.com/questions/41818245/inconsistent-figure-coordinates-in-matplotlib-with-equal-aspect-ratio
  ##fig=plt.gcf()
  ##ax=plt.gca()
