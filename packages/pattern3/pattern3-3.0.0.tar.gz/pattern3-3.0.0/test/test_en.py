...
class TestInflection(unittest.TestCase):
    ...
    def test_pluralize(self):
        ...
        from pattern3.db import Datasheet
        i, n = 0, 0
...
class TestQuantification(unittest.TestCase):
    ...
    def test_extract_leading_zeros(self):
        ...
        from pattern3.text.en.inflect_quantify import zshift
...
class TestModality(unittest.TestCase):
    ...
    def test_imperative(self):
        ...
        from pattern3.text.en.modality import imperative
        for b, s in (
    ...
    def test_conditional(self):
        ...
        # situations.
        from pattern3.text.en.modality import conditional
        for b, s in (
    ...
    def test_subjunctive(self):
        ...
        from pattern3.text.en.modality import subjunctive
        for b, s in (
    ...
    def test_modality(self):
        ...
        # modified.
        from pattern3.db import Datasheet
        from pattern3.metrics import test
        sentences = []
...
class TestSentiment(unittest.TestCase):
    ...
    def test_sentiwordnet(self):
        ...
        try:
            from pattern3.text.en.wordnet import SentiWordNet
