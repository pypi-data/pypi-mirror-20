...
def createConfig(args):
    ...
    while (v not in Config.ALLOWED_VERS):
        v = promptUser("Please enter the ECS version for the profile allowed:(2.2,3.0,3.1) default:(" + str(Config.DEFAULT_VERS)  + "):")
        if (v==''):
