...
DATABASES = {
    'default': {
        ...
        'PASSWORD': mysqlpasswd,                  # Not used with sqlite3.
        'HOST':mysqlhost ,                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '%s'%mysqlport,                      # Set to empty string for default. Not used with sqlite3.
    },
}
