...
prototype::
    ...
    arg = bool: nosepin = True ;
          ``nosepin = True`` asks to raise an error if the "between" content
          contains one of the separators, which in practice can only be the
          first separator, whereas ``nosepin = True`` will imply to not do it
