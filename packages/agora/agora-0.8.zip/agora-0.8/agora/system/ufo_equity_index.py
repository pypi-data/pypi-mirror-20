...
from onyx.core import (Curve, HlocvCurve, RDate, Interpolate,
                       AddObj, GetObj, DelObj, ObjExists, ObjNotFound,
                       ObjDbTransaction, TsDbGetCurve,  TsNotFound,
                       GetVal, ValueType, FloatField, DictField, SetField,
                       StringField, ReferenceField, RetainedFactory)

from agora.system.ufo_asset import Asset
from agora.system.ufo_equity_index_contract import EquityIndexCnt
...
class EquityIndex(Asset):
    ...
    def Spot(self, graph):
        ...
        sd = mdd + RDate("-1m")
        crv = graph(self, "GetCurve", sd, mdd, field="Close")
