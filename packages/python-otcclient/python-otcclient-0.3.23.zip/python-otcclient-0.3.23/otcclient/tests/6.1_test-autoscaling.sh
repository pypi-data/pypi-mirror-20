...
#otc autoscaling create-auto-scaling-group --auto-scaling-group-name apitest --subnet-name testsubnet --vpc-name vpc-6c8a --group-name default
...
#otc ecs run-instances --count 1  --admin-pass yourpass123! --instance-type c1.medium --instance-name apitestinstance --image-name Standard_CentOS_7.2_latest --vpc-name vpc-6c8a --group-name default --subnet-name subnet-480d  --key-name nzstestbed --file1 /otc/a=/otc/a 
...
#otc ecs run-instances --count 1 --admin-pass yourpass123! --instance-type c1.medium --instance-name testinstance-public --image-name Standard_CentOS_6.8_latest --subnet-name testsubnet --vpc-name testvpc --group-name testsecgroup  --key-name nzstestbed --associate-public-ip-address --wait-instance-running
#### TODO
