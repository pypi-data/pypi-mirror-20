...
# </summary>
class MsgAckSendSpeechRecognitionCommand(object):
    #region 変数・定数定義
    #メンバーIndex offset定義
    ...
    def __init__(self):
        ...
        self.__id = haruzira_message.MSG_ACK_SEND_SPEECH_RECOGNITION_COMMAND   #メッセージID
        ...
        self.__total_len = 12                                 #送信フィールド合計サイズ
    ...
    def __get_index_timestamp(self):
    ...
    INDEX_TIME_STAMP = property(__get_index_timestamp)
    ...
    def make_send_data(self):
        ...
        try:
            data = [self.id] + [self.ack_code] + [self.err_code] + [self.padding] + list(self.time_stamp)
