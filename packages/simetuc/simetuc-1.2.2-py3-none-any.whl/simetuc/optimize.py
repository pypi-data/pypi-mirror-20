...
def optim_fun_factory(sim: simulations.Simulations,
    ...
    '''
    if not sim.cte['optimization']['all_excitations']:
        ...
        for exc_dict in sim.cte['excitations']:
            sim.cte['excitations'][exc_dict]['active'] = False
        ...
        def optim_fun_all_exc(x: np.array) -> float:
            ...
            for exc_dict in sim.cte['excitations']:
                ...
                sim.cte['excitations'][exc_dict]['active'] = True
                dynamics_sol = sim.simulate_dynamics(average=average)
                sim.cte['excitations'][exc_dict]['active'] = False
...
if __name__ == "__main__":
    ...
    cte['optimization']['all_excitations'] = True
