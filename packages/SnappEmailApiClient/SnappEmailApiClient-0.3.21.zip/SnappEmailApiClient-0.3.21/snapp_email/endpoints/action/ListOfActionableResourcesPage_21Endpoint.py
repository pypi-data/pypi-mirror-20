...
class ListOfActionableResourcesPage_21Endpoint:
    ...
    def options(self, impersonate_user_id=None, accept_type=None):
        ...
        return fill(ListOfActionableResourcesPage_21, response.json(), content_type=response.headers['Content-Type'], silence_exceptions=self.api_client.silence_fill_exceptions)
