...
setup(
    name='nereo-django-maintenance-mode',
    ...
    url='https://github.com/Nereo/django-maintenance-mode',
    download_url='https://github.com/Nereo/django-maintenance-mode/archive/%s.tar.gz' % __version__,
