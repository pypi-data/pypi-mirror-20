...
set these environment variables::
    ...
    export PANDO_ENDPOINT=http://panko.example.org:8041
...
and :option:`--project-id`. You can alternatively set these environment variables::
    ...
    export PANDO_ENDPOINT=http://panko.example.org:8041
    export PANDO_USER_ID=99aae-4dc2-4fbc-b5b8-9688c470d9cc
    export PANDO_PROJECT_ID=c8d27445-48af-457c-8e0d-1de7103eae1f
