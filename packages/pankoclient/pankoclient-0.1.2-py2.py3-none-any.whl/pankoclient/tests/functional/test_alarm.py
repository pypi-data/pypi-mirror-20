...
from pankoclient.tests.functional import base


class PankoClientTest(base.ClientTestBase):

    def test_help(self):
        self.panko("help", params="alarm create")
        self.panko("help", params="alarm delete")
        self.panko("help", params="alarm list")
        self.panko("help", params="alarm show")
        self.panko("help", params="alarm update")

    def test_alarm_id_or_name_scenario(self):
        def _test(name):
            params = "create --type event --name %s" % name
            result = self.panko('alarm', params=params)
    ...
    def test_event_scenario(self):
        ...
        # LIST
        result = self.panko('alarm', params="list")
        ...
        # DELETE
        result = self.panko('alarm', params="delete %s" % ALARM_ID)
        self.assertEqual("", result)

        # GET FAIL
        result = self.panko('alarm', params="show %s" % ALARM_ID,
                           fail_ok=True, merge_stderr=True)
    ...
    def test_threshold_scenario(self):
        ...
        self.panko('alarm', params="delete %s" % created_alarm_id)
    ...
    def _test_alarm_create_show_query(self, create_params, expected_lines):
        ...
        test(params)
        self.panko('alarm', params='delete %s' % alarm['alarm_id'])
    ...
    def test_set_get_alarm_state(self):
        ...
        result = self.panko('alarm', params="state get %s" % alarm_id)
        ...
        self.panko('alarm', params='delete %s' % alarm_id)


class PankoClientGnocchiRulesTest(base.ClientTestBase):
