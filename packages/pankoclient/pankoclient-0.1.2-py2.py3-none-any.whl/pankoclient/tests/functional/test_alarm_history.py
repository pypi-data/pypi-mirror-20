...
class AlarmHistoryTest(base.ClientTestBase):
    ...
    def test_help(self):
        self.panko("help", params="alarm-history show")
        self.panko("help", params="alarm-history search")
    ...
    def test_alarm_history_scenario(self):
        ...
        # list with limit
        result = self.panko('alarm-history',
        ...
        # SEARCH ALL
        result = self.panko('alarm-history', params=("search"))
        ...
        self.panko('alarm', params="delete %s" % ALARM_ID2)
