...
def fetch_dictionary(analysis='tissue'):
    ...
    if analysis == 'tissue':
        url_tissue += 'TissueEnrichmentAnalysis/anatomy_dict.csv'
    elif analysis == 'phenotype':
        url_tissue += 'TissueEnrichmentAnalysis/phenotype_dict.csv'
    elif analysis == 'go':
        url_tissue += 'TissueEnrichmentAnalysis/go_dict.csv'
