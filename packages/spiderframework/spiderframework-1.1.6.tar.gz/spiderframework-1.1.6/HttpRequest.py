...
def ghNetWork(RequestModel):
    ...
    _result = requests.post(RequestModel.api(), headers=headers,data=data) if httpPost else requests.get(RequestModel.api(), headers=headers,data=data)
    RequestModel.response(_result)
